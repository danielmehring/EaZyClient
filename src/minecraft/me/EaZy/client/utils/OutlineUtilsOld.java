...
public class OutlineUtilsOld {

    public static final int EaZy = 234;
    ...
    private static void setColor(final Color c) {
    ...
    private static void setupFBO(final Framebuffer fbo) {
        ...
        EXTFramebufferObject.glRenderbufferStorageEXT(EXTFramebufferObject.GL_RENDERBUFFER_EXT,
                EXTPackedDepthStencil.GL_DEPTH_STENCIL_EXT, Minecraft.displayWidth, Minecraft.displayHeight);
