...
public class GommeWTF extends Module {

	public static GommeWTF mod;

	public static final int EaZy = 2054;
	...
	public GommeWTF() {
		super("GommeWTF", 0, "", Category.SPEED);
		Client.setmgr.rSetting(new Setting("Delay", this, 4, 2, 10, true));
		mod = this;
	}
