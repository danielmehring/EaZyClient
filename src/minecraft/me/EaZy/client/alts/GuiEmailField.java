...
public class GuiEmailField extends Gui {
    ...
    public static final int EaZy = 28;
    ...
    public GuiEmailField(final int p_i45542_1_, final FontRenderer p_i45542_2_, final int p_i45542_3_,
    ...
    public void drawTextBox() {
        if (getVisible()) {
            ...
            if (var4.length() > 0) {
                ...
                var9 = fontRendererInstance.drawString(var10, var7, var8, var1);
            }
            ...
            if (var4.length() > 0 && var5 && var2 < var4.length()) {
                var9 = fontRendererInstance.drawString(var4.substring(var2), var9, var8, var1);
            }
            ...
            if (var6) {
                if (var13) {
                    ...
                    fontRendererInstance.drawString("_", var11, var8, var1);
                }
            }
