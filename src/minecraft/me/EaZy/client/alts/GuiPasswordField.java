...
public class GuiPasswordField extends Gui {
    ...
    public static final int EaZy = 30;
    ...
    public GuiPasswordField(final FontRenderer par1FontRenderer, final int par2, final int par3, final int par4,
            final int par5) {
    ...
    public void drawTextBox() {
        if (func_146176_q()) {
            ...
            if (var4.length() > 0) {
                ...
                var9 = field_146211_a.drawString(stars, var7, var8, var1);
            }
