...
public static final int EaZy = 1317;
	...
	// private static final String __OBFID = "http://https://fuckuskid00001773";
			...
			if (worldIn.canBlockBePlaced(field_150935_a, pos, false, side, (Entity) null, stack)) {
				...
				if (worldIn.setBlockState(pos, var11, 3)) {
					...
					worldIn.playSoundEffect(pos.getX() + 0.5F, pos.getY() + 0.5F, pos.getZ() + 0.5F,
							field_150935_a.stepSound.getPlaceSound(),
							(field_150935_a.stepSound.getVolume() + 1.0F) / 2.0F,
							field_150935_a.stepSound.getFrequency() * 0.8F);
					--stack.stackSize;
					return true;
				}
			}
