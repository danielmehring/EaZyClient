...
public static final int EaZy = 1251;

    public void lambdaStuff() {
        java.util.Arrays.asList().stream().filter((m) -> (false)).forEachOrdered((m) -> {});
    }

	// private static final String __OBFID = "http://https://fuckuskid00002160";

	void func_179534_a(final CraftingManager p_179534_1_) {
		final EnumDyeColor[] var2 = EnumDyeColor.values();
		final int var3 = var2.length;

		for (int var4 = 0; var4 < var3; ++var4) {
			final EnumDyeColor var5 = var2[var4];
	...
	static class RecipeAddPattern implements IRecipe {
		...
		public ItemStack getCraftingResult(final InventoryCrafting p_77572_1_) {
			...
			final TileEntityBanner.EnumBannerPattern var8 = func_179533_c(p_77572_1_);
			...
			if (var8 != null) {
				...
				final NBTTagCompound var10 = var2.getSubCompound("BlockEntityTag", true);
				var6 = null;
				NBTTagList var11;
		...
		private TileEntityBanner.EnumBannerPattern func_179533_c(final InventoryCrafting p_179533_1_) {
			final TileEntityBanner.EnumBannerPattern[] var2 = TileEntityBanner.EnumBannerPattern.values();
			final int var3 = var2.length;

			for (int var4 = 0; var4 < var3; ++var4) {
				final TileEntityBanner.EnumBannerPattern var5 = var2[var4];
				...
				if (var5.func_177270_d()) {
					...
					if (var5.func_177269_e()) {
						...
						for (var9 = 0; var9 < p_179533_1_.getSizeInventory() && var6; ++var9) {
							final ItemStack var14 = p_179533_1_.getStackInSlot(var9);
						...
						for (int var8 = 0; var8 < p_179533_1_.getSizeInventory() && var6; ++var8) {
							var9 = var8 / 3;
							final int var10 = var8 % 3;
							final ItemStack var11 = p_179533_1_.getStackInSlot(var8);
