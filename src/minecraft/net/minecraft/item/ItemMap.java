...
public static final int EaZy = 1306;

    public void lambdaStuff() {
        java.util.Arrays.asList().stream().filter((m) -> (false)).forEachOrdered((m) -> {});
    }

	// private static final String __OBFID = "http://https://fuckuskid00000047";
	...
	public void updateMapData(final World worldIn, final Entity p_77872_2_, final MapData p_77872_3_) {
		if (worldIn.provider.getDimensionId() == p_77872_3_.dimension && p_77872_2_ instanceof EntityPlayer) {
			...
			final MapData.MapInfo var10 = p_77872_3_.func_82568_a((EntityPlayer) p_77872_2_);
			++var10.field_82569_d;
			boolean var11 = false;
					...
					for (int var15 = var8 - var9 - 1; var15 < var8 + var9; ++var15) {
						if (var12 >= 0 && var15 >= -1 && var12 < 128 && var15 < 128) {
							...
							if (!var22.isEmpty()) {
								...
								var25 /= var4 * var4;
								double var34 = (var26 - var13) * 4.0D / (var4 + 4)
										+ ((var12 + var15 & 1) - 0.5D) * 0.4D;
								byte var35 = 1;
								...
								final MapColor var36 = Iterables.getFirst(Multisets.copyHighestCountFirst(var21),
										MapColor.airColor);
								...
								if (var15 >= 0 && var16 * var16 + var17 * var17 < var9 * var9
									...
									final byte var37 = p_77872_3_.colors[var12 + var15 * 128];
	...
	public void onUpdate(final ItemStack stack, final World worldIn, final Entity entityIn, final int itemSlot,
		...
		if (!worldIn.isRemote) {
			final MapData var6 = getMapData(stack, worldIn);
	...
	public void addInformation(final ItemStack stack, final EntityPlayer playerIn, final List tooltip,
		...
		final MapData var5 = getMapData(stack, playerIn.worldObj);
