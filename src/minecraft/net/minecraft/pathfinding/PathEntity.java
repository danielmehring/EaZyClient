...
public static final int EaZy = 1483;
	...
	// private static final String __OBFID = "http://https://fuckuskid00000575";
	...
	public Vec3 getVectorFromIndex(final Entity p_75881_1_, final int p_75881_2_) {
		final double var3 = points[p_75881_2_].xCoord + (int) (p_75881_1_.width + 1.0F) * 0.5D;
		final double var5 = points[p_75881_2_].yCoord;
		final double var7 = points[p_75881_2_].zCoord + (int) (p_75881_1_.width + 1.0F) * 0.5D;
