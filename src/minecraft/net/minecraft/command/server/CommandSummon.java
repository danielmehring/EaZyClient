...
public static final int EaZy = 994;

    public void lambdaStuff() {
        java.util.Arrays.asList().stream().filter((m) -> (false)).forEachOrdered((m) -> {});
    }

	// private static final String __OBFID = "http://https://fuckuskid00001158";
	...
	public void processCommand(final ICommandSender sender, final String[] args) throws CommandException {
		if (args.length < 1) {
			...
			if (!var12.isBlockLoaded(var4)) {
				...
				if (args.length >= 5) {
					final IChatComponent var15 = getChatComponentFromNthArg(sender, args, 4);

					try {
						var13 = JsonToNBT.parse(var15.getUnformattedText());
						var14 = true;
					} catch (final NBTException var20) {
				...
				if (var21 == null) {
					...
					for (NBTTagCompound var17 = var13; var16 != null
						...
						final Entity var18 = EntityList.createEntityFromNBT(var17.getCompoundTag("Riding"), var12);
