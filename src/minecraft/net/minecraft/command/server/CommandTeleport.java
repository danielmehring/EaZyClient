...
public static final int EaZy = 995;

    public void lambdaStuff() {
        java.util.Arrays.asList().stream().filter((m) -> (false)).forEachOrdered((m) -> {});
    }

	// private static final String __OBFID = "http://https://fuckuskid00001180";
		...
		if (args.length < 1) {
			...
			if (args.length != 1 && args.length != 2) {
				if (args.length < var3 + 3) {
					...
					int var14 = var3 + 1;
					final CommandBase.CoordinateArg var6 = func_175770_a(((Entity) var4).posX, args[var3], true);
					final CommandBase.CoordinateArg var7 = func_175767_a(((Entity) var4).posY, args[var14++], 0, 0,
							false);
					final CommandBase.CoordinateArg var8 = func_175770_a(((Entity) var4).posZ, args[var14++], true);
					final CommandBase.CoordinateArg var9 = func_175770_a(((Entity) var4).rotationYaw,
							args.length > var14 ? args[var14++] : "~", false);
					final CommandBase.CoordinateArg var10 = func_175770_a(((Entity) var4).rotationPitch,
							args.length > var14 ? args[var14] : "~", false);
					float var12;
					...
					notifyOperators(sender, this, "commands.tp.success.coordinates",
							new Object[] { ((Entity) var4).getName(), var6.func_179628_a(),
                                                            var7.func_179628_a(), var8.func_179628_a() });
				}
			} else {
				final Entity var5 = func_175768_b(sender, args[args.length - 1]);
