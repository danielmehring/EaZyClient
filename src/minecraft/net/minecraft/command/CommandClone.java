...
public static final int EaZy = 928;

    public void lambdaStuff() {
        java.util.Arrays.asList().stream().filter((m) -> (false)).forEachOrdered((m) -> {});
    }

	// private static final String __OBFID = "http://https://fuckuskid00002348";
	...
	public void processCommand(final ICommandSender sender, final String[] args) throws CommandException {
		if (args.length < 9) {
			...
			final BlockPos var5 = func_175757_a(sender, args, 6, false);
				...
				if ((args.length < 11 || !args[10].equals("force") && !args[10].equals("move"))
					...
					if (var6.minY >= 0 && var6.maxY < 256 && var7.minY >= 0 && var7.maxY < 256) {
						...
						if (var12.isAreaLoaded(var6) && var12.isAreaLoaded(var7)) {
							...
							final BlockPos var18 = new BlockPos(var7.minX - var6.minX, var7.minY - var6.minY,
									var7.minZ - var6.minZ);
							...
							if (var9) {
								...
								for (var27 = var17.iterator(); var27.hasNext(); var12.setBlockState(var29,
									...
									final TileEntity var31 = var12.getTileEntity(var29);
							...
							final ArrayList var28 = Lists.newArrayList();
							var28.addAll(var14);
							var28.addAll(var15);
							var28.addAll(var16);
							final List var30 = Lists.reverse(var28);
							Iterator var32;
							...
							final List var33 = var12.func_175712_a(var6, false);

							if (var33 != null) {
								final Iterator var35 = var33.iterator();

								while (var35.hasNext()) {
									final NextTickListEntry var37 = (NextTickListEntry) var35.next();
	...
	static class StaticCloneData {
		...
		// "http://https://fuckuskid00002347";

		public StaticCloneData(final BlockPos p_i46037_1_, final IBlockState p_i46037_2_,
				final NBTTagCompound p_i46037_3_) {
