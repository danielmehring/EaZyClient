...
public static final int EaZy = 971;
	...
	// private static final String __OBFID = "http://https://fuckuskid00000086";
	...
	public static Entity func_179652_a(final ICommandSender p_179652_0_, final String p_179652_1_,
			final Class p_179652_2_) {
	...
	public static List func_179656_b(final ICommandSender p_179656_0_, final String p_179656_1_,
			final Class p_179656_2_) {
		final Matcher var3 = tokenPattern.matcher(p_179656_1_);
		...
		if (var3.matches() && p_179656_0_.canCommandSenderUseCommand(1, "@")) {
			...
			if (!func_179655_b(p_179656_0_, var4)) {
				...
				while (var9.hasNext()) {
					final World var10 = (World) var9.next();
	...
	private static boolean func_179655_b(final ICommandSender p_179655_0_, final Map p_179655_1_) {
		...
		if (var2 != null && !EntityList.func_180125_b(var2)) {
			final ChatComponentTranslation var3 = new ChatComponentTranslation("commands.generic.entity.invalidType",
					new Object[] { var2 });
	...
	private static List func_179663_a(final Map p_179663_0_, final String p_179663_1_) {
		...
		final boolean var6 = !p_179663_1_.equals("e");
		final boolean var7 = p_179663_1_.equals("r") && var3 != null;

		if ((var3 == null || !p_179663_1_.equals("e")) && !var7) {
			if (var6) {
				var2.add(new Predicate() {
					// private static final String __OBFID =
					// "http://https://fuckuskid00002358";
		...
		if (var2 != null && var2.size() > 0) {
			var1.add(new Predicate() {
				...
				public boolean func_179603_a(final Entity p_179603_1_) {
					...
					final Iterator var3 = var2.entrySet().iterator();
					Entry var4;
					boolean var6;
					int var10;
					...
					do {
						...
						final String var8 = p_179603_1_ instanceof EntityPlayerMP ? p_179603_1_.getName()
	...
	private static List func_179660_a(final Map p_179660_0_, final Class p_179660_1_, final List p_179660_2_,
			final String p_179660_3_, final World worldIn, final BlockPos p_179660_5_) {
		...
		final Predicate var14 = Predicates.and(p_179660_2_);
		...
		if (p_179660_5_ != null) {
			...
			if (!p_179660_0_.containsKey("dx") && !p_179660_0_.containsKey("dy") && !p_179660_0_.containsKey("dz")) {
				if (var13 >= 0) {
					var19 = new AxisAlignedBB(p_179660_5_.getX() - var13, p_179660_5_.getY() - var13,
							p_179660_5_.getZ() - var13, p_179660_5_.getX() + var13 + 1, p_179660_5_.getY() + var13 + 1,
							p_179660_5_.getZ() + var13 + 1);
				...
				if (var8 && var18 && !var9) {
					final Predicate var20 = new Predicate() {
						// private static final String __OBFID =
						// "http://https://fuckuskid00002360";
	...
	private static List func_179658_a(List p_179658_0_, final Map p_179658_1_, final ICommandSender p_179658_2_,
			final Class p_179658_3_, final String p_179658_4_, final BlockPos p_179658_5_) {
		...
		if (var7 != null && p_179658_3_.isAssignableFrom(var7.getClass()) && var6 == 1 && p_179658_0_.contains(var7)
	...
	private static AxisAlignedBB func_179661_a(final BlockPos p_179661_0_, final int p_179661_1_, final int p_179661_2_,
			final int p_179661_3_) {
	...
	private static boolean func_179665_h(final Map p_179665_0_) {
		final Iterator var1 = field_179666_d.iterator();
		String var2;
		...
		while (var2.hasNext()) {
			...
			if (var3.startsWith("score_") && var3.length() > "score_".length()) {
				var1.put(var3.substring("score_".length()),
                                        MathHelper.parseIntWithDefault((String) p_96560_0_.get(var3), 1));
			}
		}
	...
	private static Map getArgumentMap(final String p_82381_0_) {
		...
		if (p_82381_0_ == null) {
			...
			for (final Matcher var4 = intListPattern.matcher(p_82381_0_); var4.find(); var3 = var4.end()) {
				String var5 = null;
			...
			if (var3 < p_82381_0_.length()) {
				final Matcher var6 = keyValueListPattern.matcher(var3 == -1 ? p_82381_0_ : p_82381_0_.substring(var3));
