...
public static final int EaZy = 929;

    public void lambdaStuff() {
        java.util.Arrays.asList().stream().filter((m) -> (false)).forEachOrdered((m) -> {});
    }

	// private static final String __OBFID = "http://https://fuckuskid00002346";
		...
		if (args.length < 9) {
			...
			if (var8 > 524288) {
				...
				if (var9.isAreaLoaded(var6) && var9.isAreaLoaded(var7)) {
					...
					var8 = 0;
					final BlockPos var11 = new BlockPos(var7.minX - var6.minX, var7.minY - var6.minY,
							var7.minZ - var6.minZ);
