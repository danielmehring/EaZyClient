...
public static final int EaZy = 925;
	...
	// private static final String __OBFID = "http://https://fuckuskid00001739";
	...
	public static BlockPos func_175757_a(final ICommandSender sender, final String[] args, final int p_175757_2_,
			final boolean p_175757_3_) throws NumberInvalidException {
		final BlockPos var4 = sender.getPosition();
		return new BlockPos(func_175769_b(var4.getX(), args[p_175757_2_], -30000000, 30000000, p_175757_3_),
				func_175769_b(var4.getY(), args[p_175757_2_ + 1], 0, 256, false),
				func_175769_b(var4.getZ(), args[p_175757_2_ + 2], -30000000, 30000000, p_175757_3_));
	}
	...
	public static double parseDouble(final String input, final double min, final double max)
	...
	public static EntityPlayerMP getPlayer(final ICommandSender sender, final String username)
	...
	public static Entity func_175768_b(final ICommandSender p_175768_0_, final String p_175768_1_)
			throws EntityNotFoundException {
		return func_175759_a(p_175768_0_, p_175768_1_, Entity.class);
	}

	public static Entity func_175759_a(final ICommandSender p_175759_0_, final String p_175759_1_,
			final Class p_175759_2_) throws EntityNotFoundException {
	...
	public static List func_175763_c(final ICommandSender p_175763_0_, final String p_175763_1_)
			throws EntityNotFoundException {
	...
	public static String func_175758_e(final ICommandSender p_175758_0_, final String p_175758_1_)
			throws EntityNotFoundException {
		try {
	...
	public static IChatComponent getChatComponentFromNthArg(final ICommandSender sender, final String[] args,
			final int p_147178_2_) throws CommandException {
	...
	public static CommandBase.CoordinateArg func_175770_a(final double p_175770_0_, final String p_175770_2_,
			final boolean p_175770_3_) throws NumberInvalidException {
		return func_175767_a(p_175770_0_, p_175770_2_, -30000000, 30000000, p_175770_3_);
	}

	public static CommandBase.CoordinateArg func_175767_a(final double p_175767_0_, String p_175767_2_,
			final int p_175767_3_, final int p_175767_4_, final boolean p_175767_5_) throws NumberInvalidException {
		...
		if (var6 && Double.isNaN(p_175767_0_)) {
			...
			if (p_175767_3_ != 0 || p_175767_4_ != 0) {
				if (var7 < p_175767_3_) {
					throw new NumberInvalidException("commands.generic.double.tooSmall",
							new Object[] { var7, p_175767_3_});
				}

				if (var7 > p_175767_4_) {
					throw new NumberInvalidException("commands.generic.double.tooBig",
							new Object[] { var7, p_175767_4_});
				}
			}
	...
	public static double func_175761_b(final double p_175761_0_, final String p_175761_2_, final boolean p_175761_3_)
			throws NumberInvalidException {
		return func_175769_b(p_175761_0_, p_175761_2_, -30000000, 30000000, p_175761_3_);
	}

	public static double func_175769_b(final double base, String input, final int min, final int max,
			final boolean centerBlock) throws NumberInvalidException {
	...
	public static void notifyOperators(final ICommandSender sender, final ICommand command, final String msgFormat,
			final Object... msgParams) {
		notifyOperators(sender, command, 0, msgFormat, msgParams);
	}

	public static void notifyOperators(final ICommandSender sender, final ICommand command, final int p_152374_2_,
			final String msgFormat, final Object... msgParams) {
		if (theAdmin != null) {
