...
public static final int EaZy = 1505;
	...
	// private static final String __OBFID = "http://https://fuckuskid00002366";

	public RealmsClickableScrolledSelectionList(final int p_i46052_1_, final int p_i46052_2_, final int p_i46052_3_,
			final int p_i46052_4_, final int p_i46052_5_) {
		proxy = new GuiClickableScrolledSelectionListProxy(this, p_i46052_1_, p_i46052_2_, p_i46052_3_, p_i46052_4_,
				p_i46052_5_);
	}
	...
	public void customMouseEvent(final int p_customMouseEvent_1_, final int p_customMouseEvent_2_,
			final int p_customMouseEvent_3_, final float p_customMouseEvent_4_, final int p_customMouseEvent_5_) {}
	...
	public void itemClicked(final int p_itemClicked_1_, final int p_itemClicked_2_, final int p_itemClicked_3_,
			final int p_itemClicked_4_, final int p_itemClicked_5_) {}

	public void renderSelected(final int p_renderSelected_1_, final int p_renderSelected_2_,
			final int p_renderSelected_3_, final Tezzelator p_renderSelected_4_) {}
