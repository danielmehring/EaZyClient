...
public static final int EaZy = 1028;
	...
	// private static final String __OBFID = "http://https://fuckuskid00000121";

	public EnchantmentProtection(final int p_i45765_1_, final ResourceLocation p_i45765_2_, final int p_i45765_3_,
			final int p_i45765_4_) {
	...
	public int calcModifierDamage(final int p_77318_1_, final DamageSource p_77318_2_) {
		if (p_77318_2_.canHarmInCreative()) {
			...
			return protectionType == 0 ? MathHelper.floor_float(var3 * 0.75F)
					: protectionType == 1 && p_77318_2_.isFireDamage() ? MathHelper.floor_float(var3 * 1.25F)
							: protectionType == 2 && p_77318_2_ == DamageSource.fall
									? MathHelper.floor_float(var3 * 2.5F)
									: protectionType == 3 && p_77318_2_.isExplosion()
											? MathHelper.floor_float(var3 * 1.5F)
											: protectionType == 4 && p_77318_2_.isProjectile()
													? MathHelper.floor_float(var3 * 1.5F) : 0;
		}
	}
	...
	public static int getFireTimeForEntity(final Entity p_92093_0_, int p_92093_1_) {
		final int var2 = EnchantmentHelper.getMaxEnchantmentLevel(Enchantment.fireProtection.effectId,
	...
	public static double func_92092_a(final Entity p_92092_0_, double p_92092_1_) {
		final int var3 = EnchantmentHelper.getMaxEnchantmentLevel(Enchantment.blastProtection.effectId,
