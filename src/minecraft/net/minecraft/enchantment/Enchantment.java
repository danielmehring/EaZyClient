...
public abstract class Enchantment {
	...
	public static final int EaZy = 1013;
	...
	public static final Enchantment feather_falling = new EnchantmentProtection(2,
	...
	// private static final String __OBFID = "http://https://fuckuskid00000105";

	public static Enchantment byID(final int p_180306_0_) {
	...
	public static Enchantment byName(String name) {
		...
		for (Enchantment e : enchantmentsList) {
			if (StatCollector.translateToLocal(e.getName()).replace(" ", "").equalsIgnoreCase(name)) {
				return e;
			}
		}
		return null;
	...
	protected Enchantment(final int p_i45771_1_, final ResourceLocation p_i45771_2_, final int p_i45771_3_,
			final EnumEnchantmentType p_i45771_4_) {
	...
	public static String[] func_180304_c() {
		final String[] var0 = new String[field_180307_E.size()];
		int var1 = 0;
		ResourceLocation var3;

		for (final Iterator var2 = field_180307_E.keySet().iterator(); var2.hasNext(); var0[var1++] = var3.toString()) {
	...
	static {
		...
		final Enchantment[] var1 = field_180311_a;
