...
public enum EnumChatFormatting {
	...
	private EnumChatFormatting(final String p_i46291_1_, final int p_i46291_2_, final String p_i46291_3_,
			final char p_i46291_4_, final int p_i46291_5_) {
		this(p_i46291_1_, p_i46291_2_, p_i46291_3_, p_i46291_4_, false, p_i46291_5_);
	}

	private EnumChatFormatting(final String p_i46292_1_, final int p_i46292_2_, final String p_i46292_3_,
			final char p_i46292_4_, final boolean p_i46292_5_) {
		this(p_i46292_1_, p_i46292_2_, p_i46292_3_, p_i46292_4_, p_i46292_5_, -1);
	}

	private EnumChatFormatting(final String p_i46293_1_, final int p_i46293_2_, final String p_i46293_3_,
			final char p_i46293_4_, final boolean p_i46293_5_, final int p_i46293_6_) {
	...
	public static EnumChatFormatting func_175744_a(final int p_175744_0_) {
		if (p_175744_0_ < 0) {
			...
			final EnumChatFormatting[] var1 = values();
			final int var2 = var1.length;

			for (int var3 = 0; var3 < var2; ++var3) {
				final EnumChatFormatting var4 = var1[var3];
