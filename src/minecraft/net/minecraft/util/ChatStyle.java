...
public static final int EaZy = 1601;
	...
	// private static final String __OBFID = "http://https://fuckuskid00001266";
	...
	public String toString() {
		return "Style{hasParent=" + (parentStyle != null) + ", color=" + color + ", bold=" + bold + ", italic=" + italic
				...
				+ ", hoverEvent=" + getChatHoverEvent() + ", insertion=" + getInsertion() + '}';
	}
	...
	public boolean equals(final Object p_equals_1_) {
		if (this == p_equals_1_) {
			...
			if (getBold() == var2.getBold() && getColor() == var2.getColor() && getItalic() == var2.getItalic()
					&& getObfuscated() == var2.getObfuscated() && getStrikethrough() == var2.getStrikethrough()
	...
	public ChatStyle createDeepCopy() {
		final ChatStyle var1 = new ChatStyle();
		var1.setBold(getBold());
		var1.setItalic(getItalic());
		var1.setStrikethrough(getStrikethrough());
		var1.setUnderlined(getUnderlined());
		var1.setObfuscated(getObfuscated());
	...
	public static class Serializer implements JsonDeserializer, JsonSerializer {
		// private static final String __OBFID =
		// "http://https://fuckuskid00001268";

		@Override
		public ChatStyle deserialize(final JsonElement p_deserialize_1_, final Type p_deserialize_2_,
					...
					if (var5.has("hoverEvent")) {
						...
						if (var6 != null) {
							...
							final IChatComponent var12 = (IChatComponent) p_deserialize_3_
									.deserialize(var6.get("value"), IChatComponent.class);
		...
		public JsonElement serialize(final ChatStyle p_serialize_1_, final Type p_serialize_2_,
