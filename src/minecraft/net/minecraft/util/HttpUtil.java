...
public static final int EaZy = 1616;
	...
	// private static final String __OBFID = "http://https://fuckuskid00001485";
	...
	public static String buildPostString(final Map data) {
		...
		final Iterator var2 = data.entrySet().iterator();
	...
	public static ListenableFuture func_180192_a(final File p_180192_0_, final String p_180192_1_,
		...
		final ListenableFuture var6 = field_180193_a.submit(new Runnable() {
			// private static final String __OBFID =
			// "http://https://fuckuskid00001486";
			@Override
			public void run() {
				...
				try {
					try {
						...
						final URLConnection var1 = var5.openConnection(p_180192_5_);
						float var6 = 0.0F;
						float var7 = p_180192_2_.entrySet().size();
						final Iterator var8 = p_180192_2_.entrySet().iterator();
						...
						final int var16 = var1.getContentLength();

						if (p_180192_4_ != null) {
							p_180192_4_.displayLoadingString(String.format("Downloading file (%.2f MB)...",
									new Object[] { var7 / 1000.0F / 1000.0F}));
						}

						if (p_180192_0_.exists()) {
							final long var17 = p_180192_0_.length();
