...
public static final int EaZy = 1653;
	...
	// private static final String __OBFID = "http://https://fuckuskid00001212";

	public StringTranslate() {
		try {
			final InputStream var1 = StringTranslate.class.getResourceAsStream("/assets/minecraft/lang/en_US.lang");
			final Iterator var2 = IOUtils.readLines(var1, Charsets.UTF_8).iterator();

			while (var2.hasNext()) {
				final String var3 = (String) var2.next();

				if (!var3.isEmpty() && var3.charAt(0) != 35) {
					final String[] var4 = Iterables.toArray(equalSignSplitter.split(var3), String.class);

					if (var4 != null && var4.length == 2) {
						final String var5 = var4[0];
						final String var6 = numericVariablePattern.matcher(var4[1]).replaceAll("%$1s");
