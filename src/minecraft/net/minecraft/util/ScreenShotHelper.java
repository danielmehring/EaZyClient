...
public static final int EaZy = 1650;
	...
	// private static final String __OBFID = "http://https://fuckuskid00000656";
	 ...
	 * frameBuffer
	 */
	public static IChatComponent saveScreenshot(final File p_148260_0_, final int p_148260_1_, final int p_148260_2_,
			final Framebuffer p_148260_3_) {
	 ...
	 */
	public static IChatComponent saveScreenshot(final File p_148259_0_, final String p_148259_1_, int p_148259_2_,
			int p_148259_3_, final Framebuffer p_148259_4_) {
		try {
			...
			if (OpenGlHelper.isFramebufferEnabled()) {
				...
				final int var8 = p_148259_4_.framebufferTextureHeight - p_148259_4_.framebufferHeight;
			...
			final ChatComponentText var13 = new ChatComponentText(var12.getName());
			var13.getChatStyle()
	...
	private static File getTimestampedPNGFileForDirectory(final File p_74290_0_) {
		final String var2 = dateFormat.format(new Date());
		int var3 = 1;

		while (true) {
			final File var1 = new File(p_74290_0_, var2 + (var3 == 1 ? "" : "_" + var3) + ".png");
