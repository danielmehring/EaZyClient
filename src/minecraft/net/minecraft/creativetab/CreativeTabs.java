...
public static final int EaZy = 1004;
	...
	public static final CreativeTabs tabCombat = new CreativeTabs(8, "combat") {
		// private static final String __OBFID =
		// "http://https://fuckuskid00000018";
		@Override
		public Item getTabIconItem() {
			return Items.golden_sword;
		}
	}.setRelevantEnchantmentTypes(new EnumEnchantmentType[] { EnumEnchantmentType.ARMOR, EnumEnchantmentType.ARMOR_FEET,
	...
	// private static final String __OBFID = "http://https://fuckuskid00000005";
	...
	public boolean hasRelevantEnchantmentType(final EnumEnchantmentType p_111226_1_) {
		if (enchantmentTypes == null) {
			...
			final EnumEnchantmentType[] var2 = enchantmentTypes;
