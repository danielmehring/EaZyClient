...
public static final int EaZy = 587;
	...
	// private static final String __OBFID = "http://https://fuckuskid00000846";
	 ...
	 */
	private void setBoxRotation(final ModelRenderer p_110682_1_, final float p_110682_2_, final float p_110682_3_,
			final float p_110682_4_) {
	...
	public void setLivingAnimations(final EntityLivingBase p_78086_1_, final float p_78086_2_, final float p_78086_3_,
		...
		final float var5 = updateHorseRotation(p_78086_1_.prevRenderYawOffset, p_78086_1_.renderYawOffset, p_78086_4_);
		final float var6 = updateHorseRotation(p_78086_1_.prevRotationYawHead, p_78086_1_.rotationYawHead, p_78086_4_);
		...
		final float var19 = MathHelper.cos(p_78086_2_ * 0.6662F + (float) Math.PI);
		...
		body.rotateAngleX = var12 * -45.0F / (180F / (float) Math.PI) + var13 * body.rotateAngleX;
		...
		backLeftShin.rotateAngleX = -0.08726646F * var12
		...
		backRightShin.rotateAngleX = -0.08726646F * var12
				+ (var19 * 0.5F * p_78086_3_ - Math.max(0.0F, -var19 * 0.5F * p_78086_3_)) * var13;
		backRightHoof.rotateAngleX = backRightShin.rotateAngleX;
		frontLeftLeg.rotateAngleX = var26;
		frontLeftShin.rotateAngleX = (frontLeftLeg.rotateAngleX + (float) Math.PI * Math.max(0.0F, 0.2F + var25 * 0.2F))
				* var12 + (var20 + Math.max(0.0F, var19 * 0.5F * p_78086_3_)) * var13;
