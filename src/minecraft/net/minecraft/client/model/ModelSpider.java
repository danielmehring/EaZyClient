...
public static final int EaZy = 608;
	...
	// private static final String __OBFID = "http://https://fuckuskid00000860";
	...
	public void setRotationAngles(final float p_78087_1_, final float p_78087_2_, final float p_78087_3_,
		...
		final float var12 = -(MathHelper.cos(p_78087_1_ * 0.6662F * 2.0F + (float) Math.PI) * 0.4F) * p_78087_2_;
		final float var13 = -(MathHelper.cos(p_78087_1_ * 0.6662F * 2.0F + (float) Math.PI / 2F) * 0.4F) * p_78087_2_;
		final float var14 = -(MathHelper.cos(p_78087_1_ * 0.6662F * 2.0F + (float) Math.PI * 3F / 2F) * 0.4F)
				* p_78087_2_;
		final float var15 = Math.abs(MathHelper.sin(p_78087_1_ * 0.6662F + 0.0F) * 0.4F) * p_78087_2_;
		final float var16 = Math.abs(MathHelper.sin(p_78087_1_ * 0.6662F + (float) Math.PI) * 0.4F) * p_78087_2_;
		final float var17 = Math.abs(MathHelper.sin(p_78087_1_ * 0.6662F + (float) Math.PI / 2F) * 0.4F) * p_78087_2_;
		final float var18 = Math.abs(MathHelper.sin(p_78087_1_ * 0.6662F + (float) Math.PI * 3F / 2F) * 0.4F)
				* p_78087_2_;
