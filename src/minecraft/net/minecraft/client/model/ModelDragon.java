...
public static final int EaZy = 581;
	...
	// private static final String __OBFID = "http://https://fuckuskid00000870";
	...
	public void render(final Entity p_78088_1_, final float p_78088_2_, final float p_78088_3_, final float p_78088_4_,
		...
		final float var9 = var8.prevAnimTime + (var8.animTime - var8.prevAnimTime) * partialTicks;
		...
		final float var16 = updateRotations(
				var8.getMovementOffsets(5, partialTicks)[0] - var8.getMovementOffsets(10, partialTicks)[0]);
		final float var17 = updateRotations(var8.getMovementOffsets(5, partialTicks)[0] + var16 / 2.0F);
		var11 += 2.0F;
		...
		for (int var19 = 0; var19 < 5; ++var19) {
			final double[] var20 = var8.getMovementOffsets(5 - var19, partialTicks);
			var21 = (float) Math.cos(var19 * 0.45F + var18) * 0.15F;
			spine.rotateAngleY = updateRotations(var20[0] - var15[0]) * (float) Math.PI / 180.0F * var14;
			spine.rotateAngleX = var21 + (float) (var20[1] - var15[1]) * (float) Math.PI / 180.0F * var14 * 5.0F;
			spine.rotateAngleZ = -updateRotations(var20[0] - var17) * (float) Math.PI / 180.0F * var14;
		...
		head.rotateAngleY = updateRotations(var22[0] - var15[0]) * (float) Math.PI / 180.0F * 1.0F;
		head.rotateAngleZ = -updateRotations(var22[0] - var17) * (float) Math.PI / 180.0F * 1.0F;
		...
		for (int var25 = 0; var25 < 12; ++var25) {
			...
			spine.rotateAngleY = (updateRotations(var22[0] - var15[0]) * var14 + 180.0F) * (float) Math.PI / 180.0F;
			spine.rotateAngleX = var24 + (float) (var22[1] - var15[1]) * (float) Math.PI / 180.0F * var14 * 5.0F;
			spine.rotateAngleZ = updateRotations(var22[0] - var17) * (float) Math.PI / 180.0F * var14;
			spine.rotationPointY = var11;
			spine.rotationPointZ = var12;
			spine.rotationPointX = var13;
			var11 = (float) (var11 + Math.sin(spine.rotateAngleX) * 10.0D);
