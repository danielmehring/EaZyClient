...
public class ResourcePackListEntryDefault extends ResourcePackListEntryNew {

public static final int EaZy = 896;
	...
	// private static final String __OBFID = "http://https://fuckuskid00000822";
	...
	public ResourcePackListEntryDefault(final GuiScreenResourcePacks p_i45052_1_) {
		...
		field_148321_e = Minecraft.getTextureManager().getDynamicTextureLocation("texturepackicon", var2);
	}
	...
	protected void func_148313_c() {
		Minecraft.getTextureManager().bindTexture(field_148321_e);
	}
