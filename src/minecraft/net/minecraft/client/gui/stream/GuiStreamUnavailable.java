...
public static final int EaZy = 561;
	...
	// private static final String __OBFID = "http://https://fuckuskid00001840";

	public GuiStreamUnavailable(final GuiScreen p_i1070_1_, final GuiStreamUnavailable.Reason p_i1070_2_) {
		this(p_i1070_1_, p_i1070_2_, (List) null);
	}

	public GuiStreamUnavailable(final GuiScreen p_i46311_1_, final GuiStreamUnavailable.Reason p_i46311_2_,
			final List p_i46311_3_) {
	...
	public void initGui() {
		if (field_152323_r.isEmpty()) {
			...
			if (field_152327_i != null) {
				...
				while (var1.hasNext()) {
					final ChatComponentTranslation var2 = (ChatComponentTranslation) var1.next();
	...
	public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
		...
		int var4 = Math.max((int) (height * 0.85D / 2.0D - field_152323_r.size() * fontRendererObj.FONT_HEIGHT / 2.0F),
				50);
		drawCenteredString(fontRendererObj, field_152324_f.getFormattedText(), width / 2,
				var4 - fontRendererObj.FONT_HEIGHT * 2, 16777215);
	...
	public static void func_152321_a(final GuiScreen p_152321_0_) {
		...
		if (!OpenGlHelper.framebufferSupported) {
			...
			var3.add(new ChatComponentTranslation("stream.unavailable.no_fbo.blend",
					new Object[] { GLContext.getCapabilities().GL_EXT_blend_func_separate}));
			var3.add(new ChatComponentTranslation("stream.unavailable.no_fbo.arb",
					new Object[] { GLContext.getCapabilities().GL_ARB_framebuffer_object}));
			var3.add(new ChatComponentTranslation("stream.unavailable.no_fbo.ext",
					new Object[] { GLContext.getCapabilities().GL_EXT_framebuffer_object}));
			...
			final List var4 = Arrays.asList(new ChatComponentTranslation[] {
	...
	public static enum Reason {
		NO_FBO("NO_FBO", 0, new ChatComponentTranslation("stream.unavailable.no_fbo",
				new Object[0])), LIBRARY_ARCH_MISMATCH("LIBRARY_ARCH_MISMATCH", 1, new ChatComponentTranslation(
						"stream.unavailable.library_arch_mismatch", new Object[0])), LIBRARY_FAILURE("LIBRARY_FAILURE",
								2, new ChatComponentTranslation("stream.unavailable.library_failure", new Object[0]),
								new ChatComponentTranslation("stream.unavailable.report_to_mojang",
										new Object[0])), UNSUPPORTED_OS_WINDOWS("UNSUPPORTED_OS_WINDOWS",
												3,
												new ChatComponentTranslation("stream.unavailable.not_supported.windows",
														new Object[0])), UNSUPPORTED_OS_MAC("UNSUPPORTED_OS_MAC",
																4,
		...
		private Reason(final String p_i1067_1_, final int p_i1067_2_, final IChatComponent p_i1067_3_,
				final IChatComponent p_i1067_4_) {
