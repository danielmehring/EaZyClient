...
public class NetHandlerPlayClient implements INetHandlerPlayClient {
	...
	public static final int EaZy = 630;
	...
	public NetHandlerPlayClient(final Minecraft mcIn, final GuiScreen p_i46300_2_, final NetworkManager p_i46300_3_,
			final GameProfile p_i46300_4_) {
		gameController = mcIn;
	...
	public void handleJoinGame(final S01PacketJoinGame packetIn) {
		PacketThreadUtil.handlePacketWhileBaum(packetIn, this, gameController);
		Minecraft.playerController = new PlayerControllerMP(gameController, this);
		clientWorldController = new WorldClient(this,
				new WorldSettings(0L, packetIn.getGameMode(), false, packetIn.func_149195_d(), packetIn.getWorldType()),
				packetIn.func_149194_f(), packetIn.getDifficulty(), Minecraft.mcProfiler);
		...
		Minecraft.playerController.setGameType(packetIn.getGameMode());
	...
	public void handleSpawnObject(final S0EPacketSpawnObject packetIn) {
		...
		case 10:
			var8 = EntityMinecart.func_180458_a(clientWorldController, var2, var4, var6,
					EntityMinecart.EnumMinecartType.func_180038_a(packetIn.func_149009_m()));
			break;
		case 90:
			final Entity var9 = clientWorldController.getEntityByID(packetIn.func_149009_m());
		...
		case 61:
			...
			break;
		case 71:
			var8 = new EntityItemFrame(clientWorldController, new BlockPos(MathHelper.floor_double(var2),
					MathHelper.floor_double(var4), MathHelper.floor_double(var6)),
					EnumFacing.getHorizontal(packetIn.func_149009_m()));
			packetIn.func_149002_g(0);
			break;
		case 77:
			var8 = new EntityLeashKnot(clientWorldController, new BlockPos(MathHelper.floor_double(var2),
					MathHelper.floor_double(var4), MathHelper.floor_double(var6)));
			packetIn.func_149002_g(0);
			break;
		case 65:
		...
		case 72:
			...
			break;
		case 76:
			var8 = new EntityFireworkRocket(clientWorldController, var2, var4, var6, (ItemStack) null);
			break;
		case 63:
			var8 = new EntityLargeFireball(clientWorldController, var2, var4, var6, packetIn.func_149010_g() / 8000.0D,
					packetIn.func_149004_h() / 8000.0D, packetIn.func_148999_i() / 8000.0D);
			packetIn.func_149002_g(0);
			break;
		case 64:
			var8 = new EntitySmallFireball(clientWorldController, var2, var4, var6, packetIn.func_149010_g() / 8000.0D,
					packetIn.func_149004_h() / 8000.0D, packetIn.func_148999_i() / 8000.0D);
			packetIn.func_149002_g(0);
			break;
		case 66:
			var8 = new EntityWitherSkull(clientWorldController, var2, var4, var6, packetIn.func_149010_g() / 8000.0D,
					packetIn.func_149004_h() / 8000.0D, packetIn.func_148999_i() / 8000.0D);
			packetIn.func_149002_g(0);
			break;
		case 62:
			...
			break;
		case 73:
			var8 = new EntityPotion(clientWorldController, var2, var4, var6, packetIn.func_149009_m());
			packetIn.func_149002_g(0);
			break;
		case 75:
		...
		case 1:
			...
			break;
		case 50:
			var8 = new EntityTNTPrimed(clientWorldController, var2, var4, var6, (EntityLivingBase) null);
			break;
		case 78:
		...
		if (var8 != null) {
			...
			if (packetIn.func_149009_m() > 0) {
				if (packetIn.func_148993_l() == 60) {
					final Entity var13 = clientWorldController.getEntityByID(packetIn.func_149009_m());
	...
	public void handleSpawnExperienceOrb(final S11PacketSpawnExperienceOrb packetIn) {
		PacketThreadUtil.handlePacketWhileBaum(packetIn, this, gameController);
		final EntityXPOrb var2 = new EntityXPOrb(clientWorldController, packetIn.func_148984_d(),
	...
	public void handleSpawnPainting(final S10PacketSpawnPainting packetIn) {
		PacketThreadUtil.handlePacketWhileBaum(packetIn, this, gameController);
		final EntityPainting var2 = new EntityPainting(clientWorldController, packetIn.func_179837_b(),
	...
	public void handleEntityVelocity(final S12PacketEntityVelocity packetIn) {
		PacketThreadUtil.handlePacketWhileBaum(packetIn, this, gameController);
		final Entity var2 = clientWorldController.getEntityByID(packetIn.entityID());

		if (var2 != null) {
			var2.setVelocity(packetIn.getX() / 8000.0D, packetIn.getY() / 8000.0D, packetIn.getZ() / 8000.0D);
		}
	}
	...
	public void handleEntityMetadata(final S1CPacketEntityMetadata packetIn) {
		PacketThreadUtil.handlePacketWhileBaum(packetIn, this, gameController);
		final Entity var2 = clientWorldController.getEntityByID(packetIn.func_149375_d());
	...
	public void handleSpawnPlayer(final S0CPacketSpawnPlayer packetIn) {
		...
		final EntityOtherPlayerMP var10 = new EntityOtherPlayerMP(Minecraft.theWorld,
		...
		// TODO: bots oder so
		// System.out.println(Arrays.asList(var10.getName(), var2, var4, var6,
		// var8, var9, var11));
	...
	public void handleEntityTeleport(final S18PacketEntityTeleport packetIn) {
		PacketThreadUtil.handlePacketWhileBaum(packetIn, this, gameController);
		final Entity var2 = clientWorldController.getEntityByID(packetIn.getID());

		if (var2 != null) {
			var2.serverPosX = packetIn.getPosX();
			var2.serverPosY = packetIn.getPosY();
			var2.serverPosZ = packetIn.getPosZ();
			...
			var2.onGround = packetIn.onGround();
		}
	}
	...
	public void handleEntityMovement(final S14PacketEntity packetIn) {
		PacketThreadUtil.handlePacketWhileBaum(packetIn, this, gameController);
		final Entity var2 = packetIn.func_149065_a(clientWorldController);
	...
	public void handleEntityHeadLook(final S19PacketEntityHeadLook packetIn) {
		PacketThreadUtil.handlePacketWhileBaum(packetIn, this, gameController);
		final Entity var2 = packetIn.func_149381_a(clientWorldController);
	...
	public void handlePlayerPosLook(final S08PacketPlayerPosLook packetIn) {
		...
		netManager.sendPacket(new C03PacketPlayer.C06PacketPlayerPosLook(var2.posX, var2.getEntityBoundingBox().minY,
				var2.posZ, var2.rotationYaw, var2.rotationPitch, false));
	...
	public void handleChunkData(final S21PacketChunkData packetIn) {
		...
		final Chunk var2 = clientWorldController.getChunkFromChunkCoords(packetIn.func_149273_e(),
	...
	public void handleCollectItem(final S0DPacketCollectItem packetIn) {
		PacketThreadUtil.handlePacketWhileBaum(packetIn, this, gameController);
		final Entity var2 = clientWorldController.getEntityByID(packetIn.func_149354_c());
		Object var3 = clientWorldController.getEntityByID(packetIn.func_149353_d());
		...
		if (var2 != null) {
			...
			Minecraft.effectRenderer.addEffect(new EntityPickupFX(clientWorldController, var2, (Entity) var3, 0.5F));
	...
	public void handleChat(final S02PacketChat packetIn) {
		...
		if (packetIn.func_179841_c() == 2) {
			...
			if (packetIn.func_148915_c().getUnformattedText().replace(" ", "").isEmpty()) {
				noContentCounter++;
			} else {
				noContentCounter = 0;
				block = false;
			}
			if (noContentCounter >= 3) {
				if (!block) {
					Client.msg("§2ClearChat was prevented.");
				}
				block = true;
			}
			if (!block)
	...
	public void handleAnimation(final S0BPacketAnimation packetIn) {
		PacketThreadUtil.handlePacketWhileBaum(packetIn, this, gameController);
		final Entity var2 = clientWorldController.getEntityByID(packetIn.func_148978_c());

		if (var2 != null) {
			switch (packetIn.func_148977_d()) {
			case 0:
				// Swing item
			...
			case 4:
				// Crit
				Minecraft.effectRenderer.spawnParticle(var2, EnumParticleTypes.CRIT);
				break;
			case 5:
				// Magic Crit
				Minecraft.effectRenderer.spawnParticle(var2, EnumParticleTypes.CRIT_MAGIC);
				break;
			default:
				break;
			}
	...
	public void handleSpawnMob(final S0FPacketSpawnMob packetIn) {
		...
		final EntityLivingBase var10 = (EntityLivingBase) EntityList.createEntityByID(packetIn.func_149025_e(),
				Minecraft.theWorld);
	...
	public void handleEntityAttach(final S1BPacketEntityAttach packetIn) {
		...
		final Entity var3 = clientWorldController.getEntityByID(packetIn.func_149402_e());
		...
		if (packetIn.func_149404_c() == 0) {
			...
			if (var4) {
				final GameSettings var5 = Minecraft.gameSettings;
	...
	public void handleEntityStatus(final S19PacketEntityStatus packetIn) {
		PacketThreadUtil.handlePacketWhileBaum(packetIn, this, gameController);
		final Entity var2 = packetIn.func_149161_a(clientWorldController);
		...
		if (packetIn.func_149082_c() != Minecraft.thePlayer.dimension) {
			...
			clientWorldController = new WorldClient(this,
					new WorldSettings(0L, packetIn.func_149083_e(), false,
							Minecraft.theWorld.getWorldInfo().isHardcoreModeEnabled(), packetIn.func_149080_f()),
					packetIn.func_149082_c(), packetIn.func_149081_d(), Minecraft.mcProfiler);
	...
	public void handleExplosion(final S27PacketExplosion packetIn) {
		PacketThreadUtil.handlePacketWhileBaum(packetIn, this, gameController);
		final Explosion var2 = new Explosion(Minecraft.theWorld, (Entity) null, packetIn.func_149148_f(),
	...
	public void handleOpenWindow(final S2DPacketOpenWindow packetIn) {
		...
		if ("minecraft:container".equals(packetIn.func_148902_e())) {
			...
			final Entity var3 = clientWorldController.getEntityByID(packetIn.func_148897_h());
			...
			final ContainerLocalMenu var4 = new ContainerLocalMenu(packetIn.func_148902_e(), packetIn.func_179840_c(),
	...
	public void handleSetSlot(final S2FPacketSetSlot packetIn) {
		...
		if (packetIn.func_149175_c() == -1) {
			...
			if (packetIn.func_149175_c() == 0 && packetIn.func_149173_d() >= 36 && packetIn.func_149173_d() < 45) {
				...
				// System.out.println(packetIn.func_149173_d() + ", " +
				// packetIn.func_149174_e().getDisplayName());
	...
	public void handleUpdateSign(final S33PacketUpdateSign packetIn) {
		...
		if (Minecraft.theWorld.isBlockLoaded(packetIn.func_179704_a())) {
			final TileEntity var3 = Minecraft.theWorld.getTileEntity(packetIn.func_179704_a());
		...
		if (!var2 && Minecraft.thePlayer != null) {
			System.out.println("Unable to locate sign at " + packetIn.func_179704_a().getX() + ", "
	...
	public void handleUpdateTileEntity(final S35PacketUpdateTileEntity packetIn) {
		...
		if (Minecraft.theWorld.isBlockLoaded(packetIn.func_179823_a())) {
			final TileEntity var2 = Minecraft.theWorld.getTileEntity(packetIn.func_179823_a());
	...
	public void handleEntityEquipment(final S04PacketEntityEquipment packetIn) {
		PacketThreadUtil.handlePacketWhileBaum(packetIn, this, gameController);
		final Entity var2 = clientWorldController.getEntityByID(packetIn.func_149389_d());
	...
	public void handleBlockAction(final S24PacketBlockAction packetIn) {
		PacketThreadUtil.handlePacketWhileBaum(packetIn, this, gameController);
		Minecraft.theWorld.addBlockEvent(packetIn.func_179825_a(), packetIn.getBlockType(), packetIn.getData1(),
				packetIn.getData2());
	}
	...
	public void handleBlockBreakAnim(final S25PacketBlockBreakAnim packetIn) {
		PacketThreadUtil.handlePacketWhileBaum(packetIn, this, gameController);
		Minecraft.theWorld.sendBlockBreakProgress(packetIn.func_148845_c(), packetIn.func_179821_b(),
	...
	public void handleMapChunkBulk(final S26PacketMapChunkBulk packetIn) {
		...
		for (int var2 = 0; var2 < packetIn.func_149254_d(); ++var2) {
			...
			clientWorldController.invalidateBlockReceiveRegion(var3 << 4, 0, var4 << 4, (var3 << 4) + 15, 256,
					(var4 << 4) + 15);
			final Chunk var5 = clientWorldController.getChunkFromChunkCoords(var3, var4);
	...
	public void handleChangeGameState(final S2BPacketChangeGameState packetIn) {
		...
		case 5:
			...
			case 0:
				...
				break;
			case 101:
				gameController.ingameGUI.getChatGUI()
			...
			break;
		case 6:
			clientWorldController.playSound(var2.posX, var2.posY + var2.getEyeHeight(), var2.posZ,
		...
		case 8:
			...
			break;
		case 10:
			clientWorldController.spawnParticle(EnumParticleTypes.MOB_APPEARANCE, var2.posX, var2.posY, var2.posZ, 0.0D,
					0.0D, 0.0D, new int[0]);
			clientWorldController.playSound(var2.posX, var2.posY, var2.posZ, "mob.guardian.curse", 1.0F, 1.0F, false);
			break;
		default:
			break;
		}
	...
	public void handleMaps(final S34PacketMaps packetIn) {
		PacketThreadUtil.handlePacketWhileBaum(packetIn, this, gameController);
		final MapData var2 = ItemMap.loadMapData(packetIn.getMapId(), Minecraft.theWorld);
		packetIn.func_179734_a(var2);
		Minecraft.entityRenderer.getMapItemRenderer().func_148246_a(var2);
	}
	...
	public void handleEffect(final S28PacketEffect packetIn) {
		...
		if (packetIn.isSoundServerwide()) {
			Minecraft.theWorld.func_175669_a(packetIn.getSoundType(), packetIn.func_179746_d(),
	...
	public void handleStatistics(final S37PacketStatistics packetIn) {
		...
		for (final Iterator var3 = packetIn.func_148974_c().entrySet().iterator(); var3.hasNext(); Minecraft.thePlayer
				.getStatFileWriter().func_150873_a(Minecraft.thePlayer, var5, var6)) {
		...
		if (!field_147308_k && !var2 && Minecraft.gameSettings.showInventoryAchievementHint) {
	...
	public void handleEntityEffect(final S1DPacketEntityEffect packetIn) {
		PacketThreadUtil.handlePacketWhileBaum(packetIn, this, gameController);
		final Entity var2 = clientWorldController.getEntityByID(packetIn.func_149426_d());

		if (var2 instanceof EntityLivingBase) {
			final PotionEffect var3 = new PotionEffect(packetIn.func_149427_e(), packetIn.func_180755_e(),
	...
	public void func_175098_a(final S42PacketCombatEvent p_175098_1_) {
		PacketThreadUtil.handlePacketWhileBaum(p_175098_1_, this, gameController);
		final Entity var2 = clientWorldController.getEntityByID(p_175098_1_.field_179775_c);
		...
		if (p_175098_1_.field_179776_a == S42PacketCombatEvent.Event.END_COMBAT) {
			...
			final MetadataCombat var6 = new MetadataCombat(Minecraft.thePlayer, var3);
			...
			final Entity var7 = clientWorldController.getEntityByID(p_175098_1_.field_179774_b);
	...
	public void func_175101_a(final S41PacketServerDifficulty p_175101_1_) {
		PacketThreadUtil.handlePacketWhileBaum(p_175101_1_, this, gameController);
	...
	public void func_175094_a(final S43PacketCamera p_175094_1_) {
		PacketThreadUtil.handlePacketWhileBaum(p_175094_1_, this, gameController);
		final Entity var2 = p_175094_1_.func_179780_a(clientWorldController);
	...
	public void func_175093_a(final S44PacketWorldBorder p_175093_1_) {
		PacketThreadUtil.handlePacketWhileBaum(p_175093_1_, this, gameController);
		p_175093_1_.func_179788_a(clientWorldController.getWorldBorder());
	}

	@Override
	public void func_175099_a(final S45PacketTitle p_175099_1_) {
		PacketThreadUtil.handlePacketWhileBaum(p_175099_1_, this, gameController);
		...
		gameController.ingameGUI.func_175178_a(var3, var4, p_175099_1_.func_179806_c(), p_175099_1_.func_179804_d(),
	...
	public void handleRemoveEntityEffect(final S1EPacketRemoveEntityEffect packetIn) {
		PacketThreadUtil.handlePacketWhileBaum(packetIn, this, gameController);
		final Entity var2 = clientWorldController.getEntityByID(packetIn.func_149076_c());
	...
	public void handleSoundEffect(final S29PacketSoundEffect packetIn) {
		PacketThreadUtil.handlePacketWhileBaum(packetIn, this, gameController);
		Minecraft.theWorld.playSound(packetIn.func_149207_d(), packetIn.func_149211_e(), packetIn.func_149210_f(),
	...
	public void func_175095_a(final S48PacketResourcePackSend p_175095_1_) {
		...
		if (var2.startsWith("level://")) {
			...
			final File var5 = new File(gameController.mcDataDir, "saves");
			...
			if (gameController.getCurrentServerData() != null && gameController.getCurrentServerData()
				...
				gameController.addScheduledTask(() -> {
					gameController.displayGuiScreen(new GuiYesNo((final boolean result, final int id) -> {
						...
						if (result) {
							...
							netManager.sendPacket(
									new C19PacketResourcePackStatus(var3, C19PacketResourcePackStatus.Action.ACCEPTED));
							Futures.addCallback(gameController.getResourcePackRepository().func_180601_a(var2, var3),
									new FutureCallback() {
										@Override
										public void onSuccess(final Object p_onSuccess_1_) {
							...
							netManager.sendPacket(
									new C19PacketResourcePackStatus(var3, C19PacketResourcePackStatus.Action.DECLINED));
						}
	...
	public void func_175097_a(final S49PacketUpdateEntityNBT p_175097_1_) {
		PacketThreadUtil.handlePacketWhileBaum(p_175097_1_, this, gameController);
		final Entity var2 = p_175097_1_.func_179764_a(clientWorldController);
	...
	public void handleCustomPayload(final S3FPacketCustomPayload packetIn) {
		...
		if (null != packetIn.getChannelName()) {
			...
			case "MC|Brand":
				...
				break;
			case "MC|BOpen":
				final ItemStack var12 = Minecraft.thePlayer.getCurrentEquippedItem();
				if (var12 != null && var12.getItem() == Items.written_book) {
					gameController.displayGuiScreen(new GuiScreenBook(Minecraft.thePlayer, var12, false));
				}
				break;
			default:
				break;
	...
	public void handleParticles(final S2APacketParticles packetIn) {
		...
		if (packetIn.func_149222_k() == 0) {
			...
			for (int var18 = 0; var18 < packetIn.func_149222_k(); ++var18) {
				final double var3 = avRandomizer.nextGaussian() * packetIn.func_149221_g();
				final double var5 = avRandomizer.nextGaussian() * packetIn.func_149224_h();
				final double var7 = avRandomizer.nextGaussian() * packetIn.func_149223_i();
				final double var9 = avRandomizer.nextGaussian() * packetIn.func_149227_j();
				final double var11 = avRandomizer.nextGaussian() * packetIn.func_149227_j();
				final double var13 = avRandomizer.nextGaussian() * packetIn.func_149227_j();
	...
	public void handleEntityProperties(final S20PacketEntityProperties packetIn) {
		PacketThreadUtil.handlePacketWhileBaum(packetIn, this, gameController);
		final Entity var2 = clientWorldController.getEntityByID(packetIn.func_149442_c());
	...
	public NetworkPlayerInfo func_175104_a(final String p_175104_1_) {
		final Iterator var2 = playerInfoMap.values().iterator();
