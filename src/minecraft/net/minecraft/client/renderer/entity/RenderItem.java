...
public static final int EaZy = 762;
	...
	// private static final String __OBFID = "http://https://fuckuskid00001003";
	...
	public RenderItem(final TextureManager p_i46165_1_, final ModelManager p_i46165_2_) {
		...
		if (Reflector.ItemModelMesherForge_Constructor.exists()) {
			itemModelMesher = (ItemModelMesher) Reflector.newInstance(Reflector.ItemModelMesherForge_Constructor,
	...
	public void func_175035_a(final IBakedModel p_175035_1_, final int p_175035_2_) {
		func_175045_a(p_175035_1_, p_175035_2_, (ItemStack) null);
	}
	...
	private void func_175032_a(final WorldRenderer p_175032_1_, final List p_175032_2_, final int p_175032_3_,
			final ItemStack p_175032_4_) {
		final boolean var5 = p_175032_3_ == -1 && p_175032_4_ != null;
		BakedQuad var7;
		int var8;

		for (final Iterator var6 = p_175032_2_.iterator(); var6.hasNext(); func_175033_a(p_175032_1_, var7, var8)) {
	...
	public boolean func_175050_a(final ItemStack p_175050_1_) {
		final IBakedModel var2 = itemModelMesher.getItemModel(p_175050_1_);
		return var2 == null ? false : var2.isAmbientOcclusionEnabled();
	}

	private void func_175046_c(final ItemStack p_175046_1_) {
		final IBakedModel var2 = itemModelMesher.getItemModel(p_175046_1_);
	...
	public void func_175043_b(final ItemStack p_175043_1_) {
		final IBakedModel var2 = itemModelMesher.getItemModel(p_175043_1_);
		func_175040_a(p_175043_1_, var2, ItemCameraTransforms.TransformType.NONE);
	}

	public void func_175049_a(final ItemStack p_175049_1_, final EntityLivingBase p_175049_2_,
			final ItemCameraTransforms.TransformType p_175049_3_) {
		...
		if (p_175049_2_ instanceof EntityPlayer) {
			...
			if (var6 == Items.fishing_rod && var5.fishEntity != null) {
				...
				var7 = (ModelResourceLocation) Reflector.call(var6, Reflector.ForgeItem_getModel,
						new Object[] { p_175049_1_, var5, var5.getItemInUseCount() });
			}
	...
	protected void func_175040_a(final ItemStack p_175040_1_, IBakedModel p_175040_2_,
			final ItemCameraTransforms.TransformType p_175040_3_) {
		field_175057_n.bindTexture(TextureMap.locationBlocksTexture);
	...
	public void renderItemAndEffectIntoGUI(final ItemStack p_180450_1_, final int p_180450_2_, final int p_180450_3_) {
		if (p_180450_1_ != null) {
			zLevel += 50.0F;
			...
			try {
				...
				final CrashReport var5 = CrashReport.makeCrashReport(var7, "Rendering item");
				final CrashReportCategory var6 = var5.makeCategory("Item being rendered");
				var6.addCrashSectionCallable("Item Type", new Callable() {
					// private static final String __OBFID =
					// "http://https://fuckuskid00001004";
	...
	public void renderItemOverlayIntoGUI(final FontRenderer p_175030_1_, final ItemStack p_175030_2_,
			final int p_175030_3_, final int p_175030_4_) {
		this.renderItemOverlayIntoGUI(p_175030_1_, p_175030_2_, p_175030_3_, p_175030_4_, (String) null);
	}

	public void renderItemOverlayIntoGUI(final FontRenderer p_180453_1_, final ItemStack p_180453_2_,
			final int p_180453_3_, final int p_180453_4_, final String p_180453_5_) {
		if (p_180453_2_ != null) {
			if (p_180453_2_.stackSize != 1 || p_180453_5_ != null) {
				...
				GlStateManager.disableBlend();
				p_180453_1_.func_175063_a(itemDamaged, p_180453_3_ + 19 - 2 - p_180453_1_.getStringWidth(itemDamaged),
						p_180453_4_ + 6 + 3, 16777215);
				GlStateManager.enableLighting();
			...
			if (itemDamaged1) {
				...
				if (Reflector.ForgeItem_getDurabilityForDisplay.exists()) {
					final double var8 = Reflector.callDouble(p_180453_2_.getItem(),
				...
				GlStateManager.disableAlpha();
				GlStateManager.disableBlend();
				final Tessellator var81 = Tessellator.getInstance();
				final WorldRenderer var9 = var81.getWorldRenderer();
				final int var10 = 255 - var7 << 16 | var7 << 8;
				final int var11 = (255 - var7) / 4 << 16 | 16128;
	...
	private void func_175044_a(final WorldRenderer p_175044_1_, final int p_175044_2_, final int p_175044_3_,
			final int p_175044_4_, final int p_175044_5_, final int p_175044_6_) {
	...
	public static void forgeHooksClient_putQuadColor(final WorldRenderer renderer, final BakedQuad quad,
			final int color) {
		final float cr = color & 255;
		final float cg = color >>> 8 & 255;
		final float cb = color >>> 16 & 255;
		final float ca = color >>> 24 & 255;
		final int[] vd = quad.func_178209_a();
		final int step = vd.length / 4;

		for (int i = 0; i < 4; ++i) {
			final int vc = vd[3 + step * i];
			final float vcr = vc & 255;
			final float vcg = vc >>> 8 & 255;
			final float vcb = vc >>> 16 & 255;
			final float vca = vc >>> 24 & 255;
