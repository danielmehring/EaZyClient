...
public static final int EaZy = 1860;
	...
	// private static final String __OBFID = "http://https://fuckuskid00001437";

	public WorldServer(final MinecraftServer server, final ISaveHandler saveHandlerIn, final WorldInfo info,
	...
	public World init() {
		...
		if (worldInfo.func_176134_F() > 0L) {
			getWorldBorder().setTransition(worldInfo.func_176137_E(), worldInfo.func_176132_G(),
					worldInfo.func_176134_F());
		} else {
	...
	public void tick() {
		...
		if (getGameRules().getGameRuleBooleanValue("doMobSpawning")
				&& worldInfo.getTerrainType() != WorldType.DEBUG_WORLD) {
			field_175742_R.findChunksForSpawning(this, spawnHostileMobs, spawnPeacefulMobs,
	...
	public BiomeGenBase.SpawnListEntry func_175734_a(final EnumCreatureType p_175734_1_, final BlockPos p_175734_2_) {
		final List var3 = getChunkProvider().func_177458_a(p_175734_1_, p_175734_2_);
		return var3 != null && !var3.isEmpty() ? (BiomeGenBase.SpawnListEntry) WeightedRandom.getRandomItem(rand, var3)
				: null;
	}

	public boolean func_175732_a(final EnumCreatureType p_175732_1_, final BiomeGenBase.SpawnListEntry p_175732_2_,
			final BlockPos p_175732_3_) {
		final List var4 = getChunkProvider().func_177458_a(p_175732_1_, p_175732_3_);
	...
	public void updateAllPlayersSleepingFlag() {
		...
		if (!playerEntities.isEmpty()) {
			int var1 = 0;
			int var2 = 0;
			final Iterator var3 = playerEntities.iterator();

			while (var3.hasNext()) {
				final EntityPlayer var4 = (EntityPlayer) var3.next();

				if (var4.isSpectatorMode()) {
					++var1;
	...
	public boolean areAllPlayersAsleep() {
		if (allPlayersSleeping && !isRemote) {
			...
			while (!var2.isSpectatorMode() && var2.isPlayerFullyAsleep());
	...
	protected void func_147456_g() {
		...
		if (worldInfo.getTerrainType() == WorldType.DEBUG_WORLD) {
			final Iterator var21 = activeChunkSet.iterator();

			while (var21.hasNext()) {
				final ChunkCoordIntPair var22 = (ChunkCoordIntPair) var21.next();
				getChunkFromChunkCoords(var22.chunkXPos, var22.chunkZPos).func_150804_b(false);
			}
		} else {
			for (final Iterator var3 = activeChunkSet.iterator(); var3.hasNext(); theProfiler.endSection()) {
				...
				final Chunk var7 = getChunkFromChunkCoords(var4.chunkXPos, var4.chunkZPos);
				...
				if (rand.nextInt(16) == 0) {
					...
					final BlockPos var10 = var9.offsetDown();
				...
				if (var8 > 0) {
					final ExtendedBlockStorage[] var23 = var7.getBlockStorageArray();
					final int var24 = var23.length;

					for (int var11 = 0; var11 < var24; ++var11) {
						final ExtendedBlockStorage var12 = var23[var11];

						if (var12 != null && var12.getNeedsRandomTick()) {
							for (int var13 = 0; var13 < var8; ++var13) {
								updateLCG = updateLCG * 3 + 1013904223;
								final int var14 = updateLCG >> 2;
								final int var15 = var14 & 15;
								final int var16 = var14 >> 8 & 15;
								final int var17 = var14 >> 16 & 15;
								final BlockPos var18 = new BlockPos(var15 + var5, var17 + var12.getYLocation(),
										var16 + var6);
								final IBlockState var19 = var12.get(var15, var17, var16);
								final Block var20 = var19.getBlock();
	...
	protected BlockPos func_175736_a(final BlockPos p_175736_1_) {
		final BlockPos var2 = func_175725_q(p_175736_1_);
		final AxisAlignedBB var3 = new AxisAlignedBB(var2, new BlockPos(var2.getX(), getHeight(), var2.getZ()))
				.expand(3.0D, 3.0D, 3.0D);
		final List var4 = func_175647_a(EntityLivingBase.class, var3, new Predicate() {
			// private static final String __OBFID =
			// "http://https://fuckuskid00001889";
	...
	@Override
	public void func_175654_a(final BlockPos p_175654_1_, final Block p_175654_2_, int p_175654_3_,
		...
		if (scheduledUpdatesAreImmediate && p_175654_2_.getMaterial() != Material.air) {
			if (p_175654_2_.requiresUpdates()) {
				...
				if (this.isAreaLoaded(var5.field_180282_a.add(-var6, -var6, -var6),
					...
					final IBlockState var7 = getBlockState(var5.field_180282_a);
	...
	public boolean tickUpdates(final boolean p_72955_1_) {
		if (worldInfo.getTerrainType() == WorldType.DEBUG_WORLD) {
			...
			if (var2 != pendingTickListEntriesHashSet.size()) {
				...
				final Iterator var11 = pendingTickListEntriesThisTick.iterator();
				...
				while (var11.hasNext()) {
					...
					if (this.isAreaLoaded(var4.field_180282_a.add(-var5, -var5, -var5),
						...
						final IBlockState var6 = getBlockState(var4.field_180282_a);
						...
						if (var6.getBlock().getMaterial() != Material.air
							...
							try {
								...
								final CrashReportCategory var9 = var8.makeCategory("Block being ticked");
	...
	public List func_175712_a(final StructureBoundingBox p_175712_1_, final boolean p_175712_2_) {
		...
		for (int var4 = 0; var4 < 2; ++var4) {
			...
			while (var5.hasNext()) {
				final NextTickListEntry var6 = (NextTickListEntry) var5.next();
	...
	public List func_147486_a(final int p_147486_1_, final int p_147486_2_, final int p_147486_3_,
			final int p_147486_4_, final int p_147486_5_, final int p_147486_6_) {
	...
	public void initialize(final WorldSettings settings) {
		if (!worldInfo.isInitialized()) {
			try {
				...
				final CrashReport var3 = CrashReport.makeCrashReport(var6, "Exception initializing level");
	...
	private void createSpawnPosition(final WorldSettings p_73052_1_) {
		if (!provider.canRespawnHere()) {
			...
			final WorldChunkManager var2 = provider.getWorldChunkManager();
	...
	protected void createBonusChest() {
		final WorldGeneratorBonusChest var1 = new WorldGeneratorBonusChest(bonusChestContent, 10);

		for (int var2 = 0; var2 < 10; ++var2) {
			final int var3 = worldInfo.getSpawnX() + rand.nextInt(6) - rand.nextInt(6);
			final int var4 = worldInfo.getSpawnZ() + rand.nextInt(6) - rand.nextInt(6);
			final BlockPos var5 = func_175672_r(new BlockPos(var3, 0, var4)).offsetUp();
	...
	public void saveAllChunks(final boolean p_73044_1_, final IProgressUpdate p_73044_2_) throws MinecraftException {
		if (chunkProvider.canSave()) {
			...
			final List var3 = theChunkProviderServer.func_152380_a();
	...
	public boolean addWeatherEffect(final Entity p_72942_1_) {
		if (super.addWeatherEffect(p_72942_1_)) {
			mcServer.getConfigurationManager().sendToAllNear(p_72942_1_.posX, p_72942_1_.posY, p_72942_1_.posZ, 512.0D,
					provider.getDimensionId(), new S2CPacketSpawnGlobalEntity(p_72942_1_));
			return true;
		} else {
			return false;
		}
	...
	public void addBlockEvent(final BlockPos pos, final Block blockIn, final int eventID, final int eventParam) {
		...
		final Iterator var6 = field_147490_S[blockEventCacheIndex].iterator();
		BlockEventData var7;
		...
		while (!field_147490_S[blockEventCacheIndex].isEmpty()) {
			...
			while (var2.hasNext()) {
				...
				if (func_147485_a(var3)) {
					mcServer.getConfigurationManager().sendToAllNear(var3.func_180328_a().getX(),
							var3.func_180328_a().getY(), var3.func_180328_a().getZ(), 64.0D, provider.getDimensionId(),
							new S24PacketBlockAction(var3.func_180328_a(), var3.getBlock(), var3.getEventID(),
	...
	private boolean func_147485_a(final BlockEventData p_147485_1_) {
		final IBlockState var2 = getBlockState(p_147485_1_.func_180328_a());
	...
	protected void updateWeather() {
		...
		if (prevRainingStrength != rainingStrength) {
			mcServer.getConfigurationManager().sendPacketToAllPlayersInDimension(
					new S2BPacketChangeGameState(7, rainingStrength), provider.getDimensionId());
		}

		if (prevThunderingStrength != thunderingStrength) {
			mcServer.getConfigurationManager().sendPacketToAllPlayersInDimension(
					new S2BPacketChangeGameState(8, thunderingStrength), provider.getDimensionId());
		}
		...
		if (var1 != isRaining()) {
			...
			mcServer.getConfigurationManager()
					.sendPacketToAllPlayers(new S2BPacketChangeGameState(8, thunderingStrength));
		}
	}
	...
	public void func_175739_a(final EnumParticleTypes p_175739_1_, final double p_175739_2_, final double p_175739_4_,
			final double p_175739_6_, final int p_175739_8_, final double p_175739_9_, final double p_175739_11_,
			final double p_175739_13_, final double p_175739_15_, final int... p_175739_17_) {
		func_180505_a(p_175739_1_, false, p_175739_2_, p_175739_4_, p_175739_6_, p_175739_8_, p_175739_9_, p_175739_11_,
				p_175739_13_, p_175739_15_, p_175739_17_);
	}

	public void func_180505_a(final EnumParticleTypes p_180505_1_, final boolean p_180505_2_, final double p_180505_3_,
			final double p_180505_5_, final double p_180505_7_, final int p_180505_9_, final double p_180505_10_,
			final double p_180505_12_, final double p_180505_14_, final double p_180505_16_,
			final int... p_180505_18_) {
		final S2APacketParticles var19 = new S2APacketParticles(p_180505_1_, p_180505_2_, (float) p_180505_3_,
		...
		for (int var20 = 0; var20 < playerEntities.size(); ++var20) {
			final EntityPlayerMP var21 = (EntityPlayerMP) playerEntities.get(var20);
