...
public static final int EaZy = 1676;
	...
	// private static final String __OBFID = "http://https://fuckuskid00000158";
	...
	protected final BiomeGenBase setHeight(final BiomeGenBase.Height p_150570_1_) {
		minHeight = p_150570_1_.rootHeight;
		maxHeight = p_150570_1_.variation;
		return this;
	}
	...
	public final float func_180626_a(final BlockPos p_180626_1_) {
		if (p_180626_1_.getY() > 64) {
			final float var2 = (float) (temperatureNoise.func_151601_a(p_180626_1_.getX() * 1.0D / 8.0D,
					p_180626_1_.getZ() * 1.0D / 8.0D) * 4.0D);
	...
	public int func_180627_b(final BlockPos p_180627_1_) {
		final double var2 = MathHelper.clamp_float(func_180626_a(p_180627_1_), 0.0F, 1.0F);
		final double var4 = MathHelper.clamp_float(getFloatRainfall(), 0.0F, 1.0F);
		return ColorizerGrass.getGrassColor(var2, var4);
	}

	public int func_180625_c(final BlockPos p_180625_1_) {
		final double var2 = MathHelper.clamp_float(func_180626_a(p_180625_1_), 0.0F, 1.0F);
		final double var4 = MathHelper.clamp_float(getFloatRainfall(), 0.0F, 1.0F);
	...
	public final void func_180628_b(final World worldIn, final Random p_180628_2_, final ChunkPrimer p_180628_3_,
			final int p_180628_4_, final int p_180628_5_, final double p_180628_6_) {
		IBlockState var9 = topBlock;
		IBlockState var10 = fillerBlock;
		int var11 = -1;
		final int var12 = (int) (p_180628_6_ / 3.0D + 3.0D + p_180628_2_.nextDouble() * 0.25D);
		final int var13 = p_180628_4_ & 15;
		final int var14 = p_180628_5_ & 15;
	...
	public static BiomeGenBase getBiomeFromBiomeList(final int p_180276_0_, final BiomeGenBase p_180276_1_) {
		if (p_180276_0_ >= 0 && p_180276_0_ <= biomeList.length) {
			final BiomeGenBase var2 = biomeList[p_180276_0_];
	...
	public static class SpawnListEntry extends WeightedRandom.Item {
		...
		// private static final String __OBFID =
		// "http://https://fuckuskid00000161";

		public SpawnListEntry(final Class p_i1970_1_, final int p_i1970_2_, final int p_i1970_3_,
				final int p_i1970_4_) {
			super(p_i1970_2_);
