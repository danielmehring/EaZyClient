...
public static final int EaZy = 1712;
	...
	// private static final String __OBFID = "http://https://fuckuskid00000381";
			...
			for (var3 = 0; var3 < 1024; ++var3) {
				...
				if (var4 != 0 && (var4 >> 8) + (var4 & 255) <= sectorFree.size()) {
					for (int var5 = 0; var5 < (var4 & 255); ++var5) {
						sectorFree.set((var4 >> 8) + var5, false);
					}
				}
			}
	 ...
	 */
	protected synchronized void write(final int p_76706_1_, final int p_76706_2_, final byte[] p_76706_3_,
			final int p_76706_4_) {
		try {
			...
			if (var6 != 0 && var7 == var8) {
				...
				if (var10 >= var8) {
					...
					for (var11 = 0; var11 < var8; ++var11) {
						sectorFree.set(var6 + var11, false);
					}
	 ...
	 */
	private void setChunkTimestamp(final int p_76713_1_, final int p_76713_2_, final int p_76713_3_)
			throws IOException {
