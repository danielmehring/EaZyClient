...
public static final int EaZy = 1708;

    public void lambdaStuff() {
        java.util.Arrays.asList().stream().filter((m) -> (false)).forEachOrdered((m) -> {});
    }

	// private static final String __OBFID = "http://https://fuckuskid00000379";

	public static ChunkLoader.AnvilConverterData load(final NBTTagCompound nbt) {
		final int var1 = nbt.getInteger("xPos");
		final int var2 = nbt.getInteger("zPos");
		final ChunkLoader.AnvilConverterData var3 = new ChunkLoader.AnvilConverterData(var1, var2);
	...
	public static void convertToAnvilFormat(final ChunkLoader.AnvilConverterData p_76690_0_,
			final NBTTagCompound p_76690_1_, final WorldChunkManager p_76690_2_) {
		...
		for (int var5 = 0; var5 < 8; ++var5) {
			...
			for (var7 = 0; var7 < 16 && var6; ++var7) {
				...
				while (var8 < 16 && var6) {
					...
					while (true) {
						if (var9 < 16) {
							final int var10 = var7 << 11 | var9 << 7 | var8 + (var5 << 4);
			...
			if (!var6) {
				...
				final NibbleArray var20 = new NibbleArray();
				final NibbleArray var21 = new NibbleArray();
				final NibbleArray var22 = new NibbleArray();

				for (int var23 = 0; var23 < 16; ++var23) {
					for (int var12 = 0; var12 < 16; ++var12) {
						for (int var13 = 0; var13 < 16; ++var13) {
							final int var14 = var23 << 11 | var13 << 7 | var12 + (var5 << 4);
