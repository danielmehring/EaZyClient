...
public static final int EaZy = 1706;
	...
	// private static final String __OBFID = "http://https://fuckuskid00000582";
	...
	public boolean convertMapFormat(final String p_75805_1_, final IProgressUpdate p_75805_2_) {
		...
		convertFile(new File(var7, "region"), var4, new WorldChunkManagerHell(BiomeGenBase.hell, 0.0F), var3.size(),
				var9, p_75805_2_);
		convertFile(new File(var8, "region"), var5, new WorldChunkManagerHell(BiomeGenBase.sky, 0.0F),
	...
	private void convertFile(final File p_75813_1_, final Iterable p_75813_2_, final WorldChunkManager p_75813_3_,
			int p_75813_4_, final int p_75813_5_, final IProgressUpdate p_75813_6_) {
	 ...
	 * AnvilConverterData
	 */
	private void convertChunks(final File p_75811_1_, final File p_75811_2_, final WorldChunkManager p_75811_3_,
			final int p_75811_4_, final int p_75811_5_, final IProgressUpdate p_75811_6_) {
		try {
			...
			for (int var10 = 0; var10 < 32; ++var10) {
				...
				final int var20 = (int) Math
						.round(100.0D * ((var10 + 1) * 32 + p_75811_4_ * 1024) / (p_75811_5_ * 1024));
