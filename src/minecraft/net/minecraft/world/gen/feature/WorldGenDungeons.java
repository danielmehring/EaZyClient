...
public static final int EaZy = 1742;
	...
	// private static final String __OBFID = "http://https://fuckuskid00000425";
	...
	public boolean generate(final World worldIn, final Random p_180709_2_, final BlockPos p_180709_3_) {
		...
		if (var13 >= 1 && var13 <= 5) {
				...
				while (true) {
					if (var15 < 3) {
						label197:
						{
							...
							final int var24 = p_180709_3_.getY();
							final int var25 = p_180709_3_.getZ() + p_180709_2_.nextInt(var10 * 2 + 1) - var10;
							final BlockPos var26 = new BlockPos(var16, var24, var25);

							if (worldIn.isAirBlock(var26)) {
								int var20 = 0;
								final Iterator var21 = EnumFacing.Plane.HORIZONTAL.iterator();

								while (var21.hasNext()) {
									final EnumFacing var22 = (EnumFacing) var21.next();
								...
								if (var20 == 1) {
									worldIn.setBlockState(var26,
											...
											2);
									final List var27 = WeightedRandomChestContent.func_177629_a(CHESTCONTENT,
											new WeightedRandomChestContent[] {
													Items.enchanted_book.getRandomEnchantedBook(p_180709_2_) });
									final TileEntity var28 = worldIn.getTileEntity(var26);
			...
			final TileEntity var23 = worldIn.getTileEntity(p_180709_3_);
