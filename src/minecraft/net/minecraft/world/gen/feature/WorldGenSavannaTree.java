...
public static final int EaZy = 1763;

    public void lambdaStuff() {
        java.util.Arrays.asList().stream().filter((m) -> (false)).forEachOrdered((m) -> {});
    }

	// private static final String __OBFID = "http://https://fuckuskid00000432";
		...
		if (p_180709_3_.getY() >= 1 && p_180709_3_.getY() + var4 + 1 <= 256) {
			...
			if (!var5) {
				...
				if ((var20 == Blocks.grass || var20 == Blocks.dirt) && p_180709_3_.getY() < 256 - var4 - 1) {
					...
					final EnumFacing var23 = EnumFacing.Plane.HORIZONTAL.random(p_180709_2_);
					...
					if (var23 != var21) {
						...
						for (int var25 = var14; var25 < var4 && var24 > 0; --var24) {
							if (var25 >= 1) {
								...
								final BlockPos var18 = new BlockPos(var10, var17, var11);
								final Material var19 = worldIn.getBlockState(var18).getBlock().getMaterial();

								if (var19 == Material.air || var19 == Material.leaves) {
									func_175905_a(worldIn, var18, Blocks.log2,
