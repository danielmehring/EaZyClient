...
public static final int EaZy = 1815;
	...
	// private static final String __OBFID = "http://https://fuckuskid00000514";
	...
	public MapGenVillage(final Map p_i2093_1_) {
		...
		while (var2.hasNext()) {
			...
			if (((String) var3.getKey()).equals("size")) {
				...
				field_82665_g = MathHelper.parseIntWithDefaultAndMax((String) var3.getValue(), field_82665_g,
						field_82666_h + 1);
			}
		}
	}
	...
	protected boolean canSpawnStructureAtCoords(int p_75047_1_, int p_75047_2_) {
		...
		if (var3 == var5 && var4 == var6) {
			final boolean var8 = worldObj.getWorldChunkManager().areBiomesViable(var3 * 16 + 8, var4 * 16 + 8, 0,
					villageSpawnBiomes);
	...
	public static class Start extends StructureStart {
		...
		// "http://https://fuckuskid00000515";

		public Start() {}

		public Start(final World worldIn, final Random p_i2092_2_, final int p_i2092_3_, final int p_i2092_4_,
				final int p_i2092_5_) {
			...
			final StructureVillagePieces.Start var7 = new StructureVillagePieces.Start(worldIn.getWorldChunkManager(),
					0, p_i2092_2_, (p_i2092_3_ << 4) + 2, (p_i2092_4_ << 4) + 2, var6, p_i2092_5_);
			components.add(var7);
