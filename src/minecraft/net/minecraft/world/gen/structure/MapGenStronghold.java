...
public static final int EaZy = 1811;
	...
	// private static final String __OBFID = "http://https://fuckuskid00000481";
	...
	public MapGenStronghold(final Map p_i2068_1_) {
		...
		while (var2.hasNext()) {
			...
			if (((String) var3.getKey()).equals("distance")) {
				...
				structureCoords = new ChunkCoordIntPair[MathHelper.parseIntWithDefaultAndMax((String) var3.getValue(),
	...
	protected boolean canSpawnStructureAtCoords(final int p_75047_1_, final int p_75047_2_) {
		if (!ranBiomeCheck) {
			...
			for (int var7 = 0; var7 < structureCoords.length; ++var7) {
				final double var8 = (1.25D * var6 + var3.nextDouble()) * field_82671_h * var6;
				int var10 = (int) Math.round(Math.cos(var4) * var8);
				int var11 = (int) Math.round(Math.sin(var4) * var8);
				final BlockPos var12 = worldObj.getWorldChunkManager().findBiomePosition((var10 << 4) + 8,
						(var11 << 4) + 8, 112, field_151546_e, var3);
	...
	protected StructureStart getStructureStart(final int p_75049_1_, final int p_75049_2_) {
		...
		for (var3 = new MapGenStronghold.Start(worldObj, rand, p_75049_1_, p_75049_2_); var3.getComponents().isEmpty()
				|| ((StructureStrongholdPieces.Stairs2) var3.getComponents()
						.get(0)).strongholdPortalRoom == null; var3 = new MapGenStronghold.Start(worldObj, rand,
	...
	public static class Start extends StructureStart {
		...
		public Start(final World worldIn, final Random p_i2067_2_, final int p_i2067_3_, final int p_i2067_4_) {
			...
			final StructureStrongholdPieces.Stairs2 var5 = new StructureStrongholdPieces.Stairs2(0, p_i2067_2_,
