...
public static final int EaZy = 1789;

    public void lambdaStuff() {
        java.util.Arrays.asList().stream().filter((m) -> (false)).forEachOrdered((m) -> {});
    }

	// private static final String __OBFID = "http://https://fuckuskid00000566";
	...
	public int[] getInts(final int areaX, final int areaY, final int areaWidth, final int areaHeight) {
		...
		for (int var11 = 0; var11 < areaHeight; ++var11) {
			for (int var12 = 0; var12 < areaWidth; ++var12) {
				final int var13 = func_151630_c(var9[var12 + 0 + (var11 + 1) * var7]);
				final int var14 = func_151630_c(var9[var12 + 2 + (var11 + 1) * var7]);
				final int var15 = func_151630_c(var9[var12 + 1 + (var11 + 0) * var7]);
				final int var16 = func_151630_c(var9[var12 + 1 + (var11 + 2) * var7]);
				final int var17 = func_151630_c(var9[var12 + 1 + (var11 + 1) * var7]);
