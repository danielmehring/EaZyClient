...
public static final int EaZy = 1785;
	...
	// private static final String __OBFID = "http://https://fuckuskid00000563";
	...
	public int[] getInts(final int areaX, final int areaY, final int areaWidth, final int areaHeight) {
		...
		final int[] var6 = field_151628_d.getInts(areaX - 1, areaY - 1, areaWidth + 2, areaHeight + 2);
