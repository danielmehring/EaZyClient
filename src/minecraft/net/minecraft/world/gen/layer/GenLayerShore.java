...
public static final int EaZy = 1792;

    public void lambdaStuff() {
        java.util.Arrays.asList().stream().filter((m) -> (false)).forEachOrdered((m) -> {});
    }

	// private static final String __OBFID = "http://https://fuckuskid00000568";
			...
			for (int var8 = 0; var8 < areaWidth; ++var8) {
				...
				if (var9 == BiomeGenBase.mushroomIsland.biomeID) {
					...
					if (var10 != null && var10.isSnowyBiome()) {
						...
						if (!isBiomeOceanic(var11) && !isBiomeOceanic(var12) && !isBiomeOceanic(var13)
								&& !isBiomeOceanic(var14)) {
							if (func_151633_d(var11) && func_151633_d(var12) && func_151633_d(var13)
									&& func_151633_d(var14)) {
								var6[var8 + var7 * areaWidth] = var9;
							} else {
	...
	private void func_151632_a(final int[] p_151632_1_, final int[] p_151632_2_, final int p_151632_3_,
			final int p_151632_4_, final int p_151632_5_, final int p_151632_6_, final int p_151632_7_) {
