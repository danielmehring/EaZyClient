...
public static final int EaZy = 1794;

    public void lambdaStuff() {
        java.util.Arrays.asList().stream().filter((m) -> (false)).forEachOrdered((m) -> {});
    }

	// private static final String __OBFID = "http://https://fuckuskid00000571";
	...
	public int[] getInts(int areaX, int areaY, final int areaWidth, final int areaHeight) {
			...
			for (int var16 = var9[var14 + 0 + (var13 + 1) * var7]; var14 < var7 - 1; ++var14) {
				...
				for (int var37 = 0; var37 < 4; ++var37) {
					...
					for (int var39 = 0; var39 < 4; ++var39) {
						final double var40 = (var37 - var21) * (var37 - var21) + (var39 - var19) * (var39 - var19);
						final double var42 = (var37 - var25) * (var37 - var25) + (var39 - var23) * (var39 - var23);
						final double var44 = (var37 - var29) * (var37 - var29) + (var39 - var27) * (var39 - var27);
						final double var46 = (var37 - var33) * (var37 - var33) + (var39 - var31) * (var39 - var31);
		...
		final int[] var48 = IntCache.getIntCache(areaWidth * areaHeight);
