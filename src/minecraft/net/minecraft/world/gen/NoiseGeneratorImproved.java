...
public static final int EaZy = 1803;
	...
	private static final double[] field_152385_i = new double[] { 0.0D, 0.0D, 0.0D, 0.0D, 1.0D, 1.0D, -1.0D, -1.0D,
			1.0D, 1.0D, -1.0D, -1.0D, 0.0D, 1.0D, 0.0D, -1.0D };
	// private static final String __OBFID = "http://https://fuckuskid00000534";
	...
	public final double grad(final int p_76310_1_, final double p_76310_2_, final double p_76310_4_,
			final double p_76310_6_) {
		...
		if (p_76308_9_ == 1) {
			...
			for (int var30 = 0; var30 < p_76308_8_; ++var30) {
				...
				for (var37 = 0; var37 < p_76308_10_; ++var37) {
					...
					var70 = lerp(var35, func_76309_a(permutations[var66], var31, var38),
							grad(permutations[var22], var31 - 1.0D, 0.0D, var38));
					var73 = lerp(var35, grad(permutations[var66 + 1], var31, 0.0D, var38 - 1.0D),
							grad(permutations[var22 + 1], var31 - 1.0D, 0.0D, var38 - 1.0D));
			...
			for (var37 = 0; var37 < p_76308_8_; ++var37) {
				...
				for (int var44 = 0; var44 < p_76308_10_; ++var44) {
					...
					var45 -= var47;
					final double var49 = var45 * var45 * var45 * (var45 * (var45 * 6.0D - 15.0D) + 10.0D);
					...
					for (int var51 = 0; var51 < p_76308_9_; ++var51) {
						...
						var52 -= var54;
						final double var56 = var52 * var52 * var52 * (var52 * (var52 * 6.0D - 15.0D) + 10.0D);
						...
						if (var51 == 0 || var55 != var22) {
							...
							var29 = lerp(var42, grad(permutations[var71], var38, var52, var45),
									grad(permutations[var75], var38 - 1.0D, var52, var45));
							var31 = lerp(var42, grad(permutations[var72], var38, var52 - 1.0D, var45),
									grad(permutations[var76], var38 - 1.0D, var52 - 1.0D, var45));
							var33 = lerp(var42, grad(permutations[var71 + 1], var38, var52, var45 - 1.0D),
									grad(permutations[var75 + 1], var38 - 1.0D, var52, var45 - 1.0D));
							var35 = lerp(var42, grad(permutations[var72 + 1], var38, var52 - 1.0D, var45 - 1.0D),
									grad(permutations[var76 + 1], var38 - 1.0D, var52 - 1.0D, var45 - 1.0D));
						}
