...
public static final int EaZy = 1852;
	...
	// private static final String __OBFID = "http://https://fuckuskid00000153";
			...
			for (int var8 = -2; var8 <= 2; ++var8) {
				for (int var9 = -2; var9 <= 2; ++var9) {
					for (int var10 = -1; var10 < 3; ++var10) {
						...
						worldServerInstance.setBlockState(new BlockPos(var11, var12, var13),
	...
	public boolean func_180620_b(final Entity p_180620_1_, final float p_180620_2_) {
		double var4 = -1.0D;
		final int var6 = MathHelper.floor_double(p_180620_1_.posX);
		final int var7 = MathHelper.floor_double(p_180620_1_.posZ);
		boolean var8 = true;
		Object var9 = BlockPos.ORIGIN;
		final long var10 = ChunkCoordIntPair.chunkXZ2Int(var6, var7);

		if (destinationCoordinateCache.containsItem(var10)) {
			final Teleporter.PortalPosition var12 = (Teleporter.PortalPosition) destinationCoordinateCache
					.getValueByKey(var10);
			var4 = 0.0D;
			var9 = var12;
			...
			final BlockPos var34 = new BlockPos(p_180620_1_);

			for (int var13 = -128; var13 <= 128; ++var13) {
				BlockPos var16;

				for (int var14 = -128; var14 <= 128; ++var14) {
					for (BlockPos var15 = var34.add(var13, worldServerInstance.getActualHeight() - 1 - var34.getY(),
							var14); var15.getY() >= 0; var15 = var16) {
						var16 = var15.offsetDown();

						if (worldServerInstance.getBlockState(var15).getBlock() == Blocks.portal) {
							while (worldServerInstance.getBlockState(var16 = var15.offsetDown())
									.getBlock() == Blocks.portal) {
								var15 = var16;
							}

							final double var17 = var15.distanceSq(var34);
		...
		if (var4 >= 0.0D) {
			if (var8) {
				destinationCoordinateCache.add(var10,
						new Teleporter.PortalPosition((BlockPos) var9, worldServerInstance.getTotalWorldTime()));
				destinationCoordinateKeys.add(var10);
			}
			...
			final EnumFacing var19 = EnumFacing.getHorizontal(p_180620_1_.getTeleportDirection());

			if (var18 != null) {
				EnumFacing var20 = var18.rotateYCCW();
				final BlockPos var21 = ((BlockPos) var9).offset(var18);
				...
				if (var23 && var22) {
					...
					final BlockPos var24 = ((BlockPos) var9).offset(var18);
				...
				final double var30 = p_180620_1_.motionX;
				final double var32 = p_180620_1_.motionZ;
				p_180620_1_.motionX = var30 * var26 + var32 * var29;
				p_180620_1_.motionZ = var30 * var28 + var32 * var27;
				p_180620_1_.rotationYaw = p_180620_2_ - var19.getHorizontalIndex() * 90
						+ var18.getHorizontalIndex() * 90;
			} else {
	...
	public boolean makePortal(final Entity p_85188_1_) {
							...
							for (var23 = 0; var23 < 3; ++var23) {
								for (var24 = 0; var24 < 4; ++var24) {
									for (var25 = -1; var25 < 4; ++var25) {
										...
										var27 = var19 + var25;
										final int var28 = var16 + (var24 - 1) * var22 - var23 * var21;

										if (var25 < 0
												&& !worldServerInstance.getBlockState(new BlockPos(var26, var27, var28))
														.getBlock().getMaterial().isSolid()
												|| var25 >= 0 && !worldServerInstance
							...
							for (var20 = var12; var20 < var12 + 2; ++var20) {
								...
								for (var23 = 0; var23 < 4; ++var23) {
									for (var24 = -1; var24 < 4; ++var24) {
										...
										if (var24 < 0
												&& !worldServerInstance.getBlockState(new BlockPos(var25, var26, var27))
														.getBlock().getMaterial().isSolid()
												|| var24 >= 0 && !worldServerInstance
			...
			for (var19 = -1; var19 <= 1; ++var19) {
				for (var20 = 1; var20 < 3; ++var20) {
					for (var21 = -1; var21 < 3; ++var21) {
						...
						final boolean var34 = var21 < 0;
						worldServerInstance.setBlockState(new BlockPos(var22, var23, var24),
		...
		final IBlockState var31 = Blocks.portal.getDefaultState().withProperty(BlockPortal.field_176550_a,
		...
		for (var20 = 0; var20 < 4; ++var20) {
			for (var21 = 0; var21 < 4; ++var21) {
				for (var22 = -1; var22 < 4; ++var22) {
					...
					final boolean var35 = var21 == 0 || var21 == 3 || var22 == -1 || var22 == 3;
					worldServerInstance.setBlockState(new BlockPos(var23, var24, var25),
			...
			for (var21 = 0; var21 < 4; ++var21) {
				for (var22 = -1; var22 < 4; ++var22) {
					...
					var24 = var15 + var22;
					var25 = var16 + (var21 - 1) * var18;
					worldServerInstance.notifyNeighborsOfStateChange(new BlockPos(var23, var24, var25),
							worldServerInstance.getBlockState(new BlockPos(var23, var24, var25)).getBlock());
				}
			}
		}
		...
		if (p_85189_1_ % 100L == 0L) {
			...
			while (var3.hasNext()) {
				...
				if (var7 == null || var7.lastUpdateTime < var4) {
					var3.remove();
					destinationCoordinateCache.remove(var6);
				}
			}
		}
	}
