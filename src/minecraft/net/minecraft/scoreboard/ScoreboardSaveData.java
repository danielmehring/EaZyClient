...
public static final int EaZy = 1523;
	...
	// private static final String __OBFID = "http://https://fuckuskid00000620";
	...
	protected void func_96498_a(final NBTTagList p_96498_1_) {
		for (int var2 = 0; var2 < p_96498_1_.tagCount(); ++var2) {
			...
			final ScorePlayerTeam var4 = theScoreboard.createTeam(var3.getString("Name"));
	...
	protected void func_96501_b(final NBTTagList p_96501_1_) {
		for (int var2 = 0; var2 < p_96501_1_.tagCount(); ++var2) {
			...
			final IScoreObjectiveCriteria var4 = (IScoreObjectiveCriteria) IScoreObjectiveCriteria.INSTANCES
					.get(var3.getString("CriteriaName"));

			if (var4 != null) {
				final ScoreObjective var5 = theScoreboard.addScoreObjective(var3.getString("Name"), var4);
	...
	protected void func_96500_c(final NBTTagList p_96500_1_) {
		for (int var2 = 0; var2 < p_96500_1_.tagCount(); ++var2) {
			...
			final ScoreObjective var4 = theScoreboard.getObjective(var3.getString("Objective"));
			final Score var5 = theScoreboard.getValueFromObjective(var3.getString("Name"), var4);
	...
	protected void func_96497_d(final NBTTagCompound p_96497_1_) {
		...
		for (int var4 = 0; var4 < 19; ++var4) {
			final ScoreObjective var5 = theScoreboard.getObjectiveInDisplaySlot(var4);
