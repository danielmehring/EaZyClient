...
public static final int EaZy = 1496;
	...
	public static boolean func_82817_b(final Collection potionEffects) {
		final Iterator var1 = potionEffects.iterator();

		while (var1.hasNext()) {
			final PotionEffect var2 = (PotionEffect) var1.next();
	...
	private static int func_77904_a(final boolean p_77904_0_, final boolean p_77904_1_, final boolean p_77904_2_,
			final int p_77904_3_, final int p_77904_4_, final int p_77904_5_, final int p_77904_6_) {
		int var7 = 0;
	...
	private static int parsePotionEffects(final String p_77912_0_, final int p_77912_1_, final int p_77912_2_,
			final int p_77912_3_) {
	...
	public static List getPotionEffects(final int p_77917_0_, final boolean p_77917_1_) {
		...
		for (int var5 = 0; var5 < var4; ++var5) {
			...
			if (var6 != null && (!var6.isUsable() || p_77917_1_)) {
				final String var7 = (String) field_179539_o.get(var6.getId());
				...
				if (var7 != null) {
					...
					if (var8 > 0) {
						int var9 = 0;
						final String var10 = (String) field_179540_p.get(var6.getId());
	 ...
	 */
	private static int brewBitOperations(int p_77906_0_, final int p_77906_1_, final boolean p_77906_2_,
			final boolean p_77906_3_, final boolean p_77906_4_) {
		if (p_77906_4_) {
	...
	public static int func_77908_a(final int p_77908_0_, final int p_77908_1_, final int p_77908_2_,
			final int p_77908_3_, final int p_77908_4_, final int p_77908_5_) {
