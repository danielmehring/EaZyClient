...
public class Potion {
	...
	public static final int EaZy = 1490;
	...
	public static final Potion damageBoost = new PotionAttackDamage(5, new ResourceLocation("strength"), false, 9643043)
			.setPotionName("potion.damageBoost").setIconIndex(4, 0).registerPotionAttributeModifier(
	...
	public static final Potion absorption = new PotionAbsoption(22, new ResourceLocation("absorption"), false, 2445989)
	...
	// private static final String __OBFID = "http://https://fuckuskid00001528";

	protected Potion(final int p_i45897_1_, final ResourceLocation p_i45897_2_, final boolean p_i45897_3_,
			final int p_i45897_4_) {
		id = p_i45897_1_;
	...
	public static Potion byName(String name) {
		name = name.replace(" ", "");
		for (Potion pe : potionTypes) {
			if (pe == null)
				continue;
			if (StatCollector.translateToLocal(pe.getName()).replace(" ", "").equalsIgnoreCase(name)) {
				return pe;
			}
		}
		return null;
	...
	public static String[] func_180141_c() {
		final String[] var0 = new String[field_180150_I.size()];
		int var1 = 0;
		ResourceLocation var3;

		for (final Iterator var2 = field_180150_I.keySet().iterator(); var2.hasNext(); var0[var1++] = var3.toString()) {
	...
	public void performEffect(final EntityLivingBase p_76394_1_, final int p_76394_2_) {
		...
		} else if (id == saturation.id && p_76394_1_ instanceof EntityPlayer) {
	...
	public void func_180793_a(final Entity p_180793_1_, final Entity p_180793_2_, final EntityLivingBase p_180793_3_,
			final int p_180793_4_, final double p_180793_5_) {
		int var7;

		if ((id != heal.id || p_180793_3_.isEntityUndead()) && (id != harm.id || !p_180793_3_.isEntityUndead())) {
			if (id == harm.id && !p_180793_3_.isEntityUndead() || id == heal.id && p_180793_3_.isEntityUndead()) {
	 ...
	 */
	public Potion registerPotionAttributeModifier(final IAttribute p_111184_1_, final String p_111184_2_,
			final double p_111184_3_, final int p_111184_5_) {
		final AttributeModifier var6 = new AttributeModifier(UUID.fromString(p_111184_2_), getName(), p_111184_3_,
				p_111184_5_);
	...
	public void removeAttributesModifiersFromEntity(final EntityLivingBase p_111187_1_,
		...
		final Iterator var4 = attributeModifierMap.entrySet().iterator();

		while (var4.hasNext()) {
			final Entry var5 = (Entry) var4.next();
			final IAttributeInstance var6 = p_111187_2_.getAttributeInstance((IAttribute) var5.getKey());
	...
	public void applyAttributesModifiersToEntity(final EntityLivingBase p_111185_1_, final BaseAttributeMap p_111185_2_,
			final int p_111185_3_) {
		final Iterator var4 = attributeModifierMap.entrySet().iterator();

		while (var4.hasNext()) {
			final Entry var5 = (Entry) var4.next();
			final IAttributeInstance var6 = p_111185_2_.getAttributeInstance((IAttribute) var5.getKey());

			if (var6 != null) {
				final AttributeModifier var7 = (AttributeModifier) var5.getValue();
				var6.removeModifier(var7);
				var6.applyModifier(new AttributeModifier(var7.getID(), getName() + " " + p_111185_3_,
						func_111183_a(p_111185_3_, var7), var7.getOperation()));
			}
		}
	}
