...
public static final int EaZy = 1491;

    public void lambdaStuff() {
        java.util.Arrays.asList().stream().filter((m) -> (false)).forEachOrdered((m) -> {});
    }

	// private static final String __OBFID = "http://https://fuckuskid00001524";

	protected PotionAbsoption(final int p_i45901_1_, final ResourceLocation p_i45901_2_, final boolean p_i45901_3_,
			final int p_i45901_4_) {
