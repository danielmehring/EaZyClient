...
public static final int EaZy = 1224;
	...
	// private static final String __OBFID = "http://https://fuckuskid00001754";
		...
		if (var4 != null && var4.getHasStack()) {
			...
			if (index == 0) {
				...
				if (!mergeItemStack(var5, 9, 45, false)) {
					...
					&& !((Slot) inventorySlots.get(5 + ((ItemArmor) var3.getItem()).armorType)).getHasStack()) {
