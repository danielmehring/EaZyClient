...
public static final int EaZy = 1239;
	...
	// private static final String __OBFID = "http://https://fuckuskid00001761";

	public SlotCrafting(final EntityPlayer p_i45790_1_, final InventoryCrafting p_i45790_2_,
			final IInventory p_i45790_3_, final int p_i45790_4_, final int p_i45790_5_, final int p_i45790_6_) {
	...
	public void onPickupFromSlot(final EntityPlayer playerIn, final ItemStack stack) {
		...
		final ItemStack[] var3 = CraftingManager.getInstance().func_180303_b(craftMatrix, playerIn.worldObj);

		for (int var4 = 0; var4 < var3.length; ++var4) {
			final ItemStack var5 = craftMatrix.getStackInSlot(var4);
