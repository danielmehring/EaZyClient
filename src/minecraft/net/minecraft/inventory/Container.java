...
public static final int EaZy = 1214;
	...
	// private static final String __OBFID = "http://https://fuckuskid00001730";
	...
	public ItemStack slotClick(final int slotId, final int clickedButton, final int mode, final EntityPlayer playerIn) {
		...
		if (mode == 5) {
			...
			if ((var7 != 1 || dragEvent != 2) && var7 != dragEvent) {
				...
				final Slot var8 = (Slot) inventorySlots.get(slotId);

				if (var8 != null && canAddItemToSlot(var8, var6.getItemStack(), true)
						&& var8.isItemValid(var6.getItemStack()) && var6.getItemStack().stackSize > dragSlots.size()
				...
				if (!dragSlots.isEmpty()) {
					...
					final Iterator var10 = dragSlots.iterator();
					...
					while (var10.hasNext()) {
						...
						if (var11 != null && canAddItemToSlot(var11, var6.getItemStack(), true)
								...
								&& var6.getItemStack().stackSize >= dragSlots.size() && canDragIntoSlot(var11)) {
							final ItemStack var12 = var17.copy();
							final int var13 = var11.getHasStack() ? var11.getStack().stackSize : 0;
			...
			if ((mode == 0 || mode == 1) && (clickedButton == 0 || clickedButton == 1)) {
				...
				if (var17 != null && (var16 == null || !var16.getHasStack() || !var16.canTakeStack(playerIn))) {
					...
					for (int var22 = 0; var22 < 2; ++var22) {
						for (int var24 = var9; var24 >= 0 && var24 < inventorySlots.size()
							...
							if (var25.getHasStack() && canAddItemToSlot(var25, var17, true)
									&& var25.canTakeStack(playerIn) && func_94530_a(var17, var25) && (var22 != 0
											|| var25.getStack().stackSize != var25.getStack().getMaxStackSize())) {
								final int var14 = Math.min(var17.getMaxStackSize() - var17.stackSize,
										var25.getStack().stackSize);
								final ItemStack var15 = var25.decrStackSize(var14);
	 ...
	 */
	protected boolean mergeItemStack(final ItemStack stack, final int startIndex, final int endIndex,
			final boolean useEndIndex) {
		boolean var5 = false;
		int var6 = startIndex;
	...
	public static boolean canAddItemToSlot(final Slot slotIn, final ItemStack stack, final boolean stackSizeMatters) {
		...
		if (slotIn != null && slotIn.getHasStack() && stack != null && stack.isItemEqual(slotIn.getStack())
			...
			final int var10002 = stackSizeMatters ? 0 : stack.stackSize;
	 ...
	 */
	public static void computeStackSize(final Set p_94525_0_, final int p_94525_1_, final ItemStack p_94525_2_,
			final int p_94525_3_) {
		switch (p_94525_1_) {
			case 0:
