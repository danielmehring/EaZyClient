...
public static final int EaZy = 1113;
	...
	// private static final String __OBFID = "http://https://fuckuskid00001546";
	...
	private void func_174856_o() {
		if (field_174860_b != null) {
			...
			final double var9 = func_174858_a(getWidthPixels());
			final double var11 = func_174858_a(getHeightPixels());
			var1 -= field_174860_b.getFrontOffsetX() * 0.46875D;
			var5 -= field_174860_b.getFrontOffsetZ() * 0.46875D;
			var3 += var11;
			final EnumFacing var13 = field_174860_b.rotateYCCW();
			...
			var16 /= 32.0D;
			var18 /= 32.0D;
			func_174826_a(new AxisAlignedBB(var1 - var14, var3 - var16, var5 - var18, var1 + var14, var3 + var16,
					var5 + var18));
		}
	}
	...
	public boolean onValidSurface() {
		if (!worldObj.getCollidingBoundingBoxes(this, getEntityBoundingBox()).isEmpty()) {
			...
			final BlockPos var3 = field_174861_a.offset(field_174860_b.getOpposite());
			final EnumFacing var4 = field_174860_b.rotateYCCW();

			for (int var5 = 0; var5 < var1; ++var5) {
				for (int var6 = 0; var6 < var2; ++var6) {
					final BlockPos var7 = var3.offset(var4, var5).offsetUp(var6);
					final Block var8 = worldObj.getBlockState(var7).getBlock();
			...
			final List var9 = worldObj.getEntitiesWithinAABBExcludingEntity(this, getEntityBoundingBox());
	...
	public boolean hitByEntity(final Entity entityIn) {
		return entityIn instanceof EntityPlayer
				? attackEntityFrom(DamageSource.causePlayerDamage((EntityPlayer) entityIn), 0.0F) : false;
	}
	...
	public void readEntityFromNBT(final NBTTagCompound tagCompund) {
		field_174861_a = new BlockPos(tagCompund.getInteger("TileX"), tagCompund.getInteger("TileY"),
	...
	public void setPosition(final double x, final double y, final double z) {
		...
		posY = y;
		posZ = z;
		final BlockPos var7 = field_174861_a;
