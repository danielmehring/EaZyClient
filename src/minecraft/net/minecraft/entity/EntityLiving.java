...
public abstract class EntityLiving extends EntityLivingBase {
    ...
    public static final int EaZy = 1116;
    ...
    // private static final String __OBFID = "http://https://fuckuskid00001550";
    ...
    public EntityLiving(final World worldIn) {
        ...
        final UUID var5 = getUniqueID();
        final long uuidLow = var5.getLeastSignificantBits();
        randomMobsId = (int) (uuidLow & 2147483647L);
    }
    ...
    protected int getExperiencePoints(final EntityPlayer p_70693_1_) {
        if (experienceValue > 0) {
            ...
            final ItemStack[] var3 = getInventory();
        ...
        if (worldObj.isRemote) {
            for (int var1 = 0; var1 < 20; ++var1) {
                ...
                worldObj.spawnParticle(EnumParticleTypes.EXPLOSION_NORMAL,
                        posX + rand.nextFloat() * width * 2.0F - width - var2 * var8,
                        posY + rand.nextFloat() * height - var4 * var8,
                        posZ + rand.nextFloat() * width * 2.0F - width - var6 * var8, var2, var4, var6, new int[0]);
            }
        } else {
    ...
    public void writeEntityToNBT(final NBTTagCompound tagCompound) {
        ...
        final NBTTagList var61 = new NBTTagList();
        ...
        if (leashedToEntity != null) {
            ...
            if (leashedToEntity instanceof EntityLivingBase) {
                ...
                final BlockPos var7 = ((EntityHanging) leashedToEntity).func_174857_n();
    ...
    public void onLivingUpdate() {
        ...
        if (!worldObj.isRemote && canPickUpLoot() && !dead
            ...
            final List var1 = worldObj.getEntitiesWithinAABB(EntityItem.class,
                    getEntityBoundingBox().expand(1.0D, 0.0D, 1.0D));
    ...
    protected void func_175445_a(final EntityItem p_175445_1_) {
        ...
        if (var3 > -1) {
            boolean var4 = true;
            final ItemStack var5 = getEquipmentInSlot(var3);
            ...
            if (var5 != null) {
                if (var3 == 0) {
                    if (var2.getItem() instanceof ItemSword && !(var5.getItem() instanceof ItemSword)) {
                        ...
                        final ItemSword var9 = (ItemSword) var2.getItem();
                        final ItemSword var10 = (ItemSword) var5.getItem();
                    ...
                    final ItemArmor var91 = (ItemArmor) var2.getItem();
                    final ItemArmor var101 = (ItemArmor) var5.getItem();
            ...
            if (var4 && func_175448_a(var2)) {
                ...
                if (var2.getItem() == Items.diamond && p_175445_1_.getThrower() != null) {
                    final EntityPlayer var92 = worldObj.getPlayerEntityByName(p_175445_1_.getThrower());
    ...
    protected void despawnEntity() {
        ...
        if (persistenceRequired) {
            entityAge = 0;
        } else if ((entityAge & 31) == 31 && (result = Reflector.call(Reflector.ForgeEventFactory_canEntityDespawn,
            ...
            final EntityPlayer var1 = worldObj.getClosestPlayerToEntity(this, -1.0D);
    ...
    public void faceEntity(final Entity p_70625_1_, final float p_70625_2_, final float p_70625_3_) {
        ...
        if (p_70625_1_ instanceof EntityLivingBase) {
            final EntityLivingBase var14 = (EntityLivingBase) p_70625_1_;
        ...
        final double var141 = MathHelper.sqrt_double(var4 * var4 + var8 * var8);
        final float var12 = (float) (Math.atan2(var8, var4) * 180.0D / Math.PI) - 90.0F;
        final float var13 = (float) -(Math.atan2(var6, var141) * 180.0D / Math.PI);
    ...
    protected void func_180481_a(final DifficultyInstance p_180481_1_) {
        if (rand.nextFloat() < 0.15F * p_180481_1_.func_180170_c()) {
            ...
            final float var3 = worldObj.getDifficulty() == EnumDifficulty.HARD ? 0.1F : 0.25F;
            ...
            for (int var4 = 3; var4 >= 0; --var4) {
                final ItemStack var5 = getCurrentArmor(var4);
    ...
    protected void func_180483_b(final DifficultyInstance p_180483_1_) {
        ...
        for (int var3 = 0; var3 < 4; ++var3) {
            final ItemStack var4 = getCurrentArmor(var3);
    ...
    private void recreateLeash() {
        if (isLeashed && leashNBTTag != null) {
            if (leashNBTTag.hasKey("UUIDMost", 4) && leashNBTTag.hasKey("UUIDLeast", 4)) {
                final UUID var11 = new UUID(leashNBTTag.getLong("UUIDMost"), leashNBTTag.getLong("UUIDLeast"));
                final List var21 = worldObj.getEntitiesWithinAABB(EntityLivingBase.class,
                        getEntityBoundingBox().expand(10.0D, 10.0D, 10.0D));
                final Iterator var3 = var21.iterator();
                ...
                final BlockPos var1 = new BlockPos(leashNBTTag.getInteger("X"), leashNBTTag.getInteger("Y"),
                        leashNBTTag.getInteger("Z"));
    ...
    protected void setNoAI(final boolean p_94061_1_) {
        dataWatcher.updateObject(15, (byte) (p_94061_1_ ? 1 : 0));
    }
    ...
    public boolean isEntityInsideOpaqueBlock() {
        if (noClip) {
            ...
            for (int var1 = 0; var1 < 8; ++var1) {
                final double var2 = posX + ((var1) % 2 - 0.5F) * width * 0.8F;
    ...
    private boolean canSkipUpdate() {
        if (isChild()) {
            ...
            if (world == null) {
                ...
                final Entity player = (Entity) world.playerEntities.get(0);
                final double dx = Math.max(Math.abs(posX - player.posX) - 16.0D, 0.0D);
                final double dz = Math.max(Math.abs(posZ - player.posZ) - 16.0D, 0.0D);
    ...
    public static enum SpawnPlacementType {
        ...
        private SpawnPlacementType(final String p_i46393_1_, final int p_i46393_2_, final String p_i45893_1_,
                final int p_i45893_2_) {
        }
    }
}
