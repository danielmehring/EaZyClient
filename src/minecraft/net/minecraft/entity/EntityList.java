...
public static final int EaZy = 1115;
	...
	// private static final String __OBFID = "http://https://fuckuskid00001538";
	 ...
	 */
	private static void addMapping(final Class p_75614_0_, final String p_75614_1_, final int p_75614_2_,
			final int p_75614_3_, final int p_75614_4_) {
	...
	public static Entity createEntityFromNBT(final NBTTagCompound p_75615_0_, final World worldIn) {
		...
		try {
			final Class var3 = (Class) stringToClassMapping.get(p_75615_0_.getString("id"));
	...
	public static int getEntityID(final Entity p_75619_0_) {
		final Integer var1 = (Integer) classToIDMapping.get(p_75619_0_.getClass());
	...
	public static int func_180122_a(final String p_180122_0_) {
		final Integer var1 = (Integer) field_180126_g.get(p_180122_0_);
