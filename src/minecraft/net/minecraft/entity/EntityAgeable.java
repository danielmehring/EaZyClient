...
public static final int EaZy = 1109;
	...
	// private static final String __OBFID = "http://https://fuckuskid00001530";
	...
	public void setGrowingAge(final int p_70873_1_) {
		dataWatcher.updateObject(12, (byte) MathHelper.clamp_int(p_70873_1_, -1, 1));
			...
			if (field_175503_c > 0) {
				if (field_175503_c % 4 == 0) {
					worldObj.spawnParticle(EnumParticleTypes.VILLAGER_HAPPY,
							posX + rand.nextFloat() * width * 2.0F - width, posY + 0.5D + rand.nextFloat() * height,
							posZ + rand.nextFloat() * width * 2.0F - width, 0.0D, 0.0D, 0.0D, new int[0]);
				}
