...
public static final int EaZy = 1118;
	...
	private final CommandBlockLogic field_145824_a = new CommandBlockLogic() {
		...
		public void func_145756_e() {
			...
			EntityMinecartCommandBlock.this.getDataWatcher().updateObject(24,
					IChatComponent.Serializer.componentToJson(getLastOutput()));
		}
	...
	// private static final String __OBFID = "http://https://fuckuskid00001672";

	public EntityMinecartCommandBlock(final World worldIn) {
		super(worldIn);
	}

	public EntityMinecartCommandBlock(final World worldIn, final double p_i45322_2_, final double p_i45322_4_,
			final double p_i45322_6_) {
		...
		if (p_145781_1_ == 24) {
			try {
				field_145824_a.func_145750_b(
						IChatComponent.Serializer.jsonToComponent(getDataWatcher().getWatchableObjectString(24)));
