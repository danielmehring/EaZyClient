...
public enum EnumConnectionState {
	...
	protected EnumConnectionState registerPacket(final EnumPacketDirection direction, final Class packetClass) {
		...
		if (((BiMap) var3).containsValue(packetClass)) {
			final String var4 = direction + " packet " + packetClass + " is already known to ID "
	...
	public Packet getPacket(final EnumPacketDirection direction, final int packetId)
			throws InstantiationException, IllegalAccessException {
		final Class var3 = (Class) ((BiMap) directionMaps.get(direction)).get(packetId);
	...
	EnumConnectionState(final String p_i46000_1_, final int p_i46000_2_, final int p_i46000_3_,
			final Object p_i46000_4_) {
	...
	static {
		...
		for (int var2 = 0; var2 < var1; ++var2) {
			...
			final Iterator var4 = var3.directionMaps.keySet().iterator();

			while (var4.hasNext()) {
				final EnumPacketDirection var5 = (EnumPacketDirection) var4.next();
				Class var7;

				for (final Iterator var6 = ((BiMap) var3.directionMaps.get(var5)).values().iterator(); var6
