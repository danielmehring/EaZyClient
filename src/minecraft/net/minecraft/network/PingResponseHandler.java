...
public static final int EaZy = 1376;
	...
	// private static final String __OBFID = "http://https://fuckuskid00001444";
	...
	public void channelRead(final ChannelHandlerContext p_channelRead_1_, final Object p_channelRead_2_) {
		...
		try {
			try {
				...
				final MinecraftServer var6 = networkSystem.getServer();
				...
				switch (var7) {
					case 0:
						logger.debug("Ping: (<1.3.x) from {}:{}",
								new Object[] { var5.getAddress(), var5.getPort() });
						var8 = String.format("%s\u00a7%d\u00a7%d", new Object[] { var6.getMOTD(),
                                                    var6.getCurrentPlayerCount(), var6.getMaxPlayers() });
					...
					case 1:
						...
						var8 = String.format("\u00a71\u0000%d\u0000%s\u0000%s\u0000%d\u0000%d",
								new Object[] { 127, var6.getMinecraftVersion(), var6.getMOTD(),
                                                                    var6.getCurrentPlayerCount(),
                                                                    var6.getMaxPlayers() });
						writeAndFlush(p_channelRead_1_, getStringBuffer(var8));
						break;
					...
					default:
						...
						logger.debug("Ping: (1.6) from {}:{}",
								new Object[] { var5.getAddress(), var5.getPort() });
						final String var10 = String.format("\u00a71\u0000%d\u0000%s\u0000%s\u0000%d\u0000%d",
								new Object[] { 127, var6.getMinecraftVersion(), var6.getMOTD(),
                                                                    var6.getCurrentPlayerCount(),
                                                                    var6.getMaxPlayers() });
						final ByteBuf var11 = getStringBuffer(var10);
