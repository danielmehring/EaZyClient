...
public static final int EaZy = 1211;
	...
	// private static final String __OBFID = "http://https://fuckuskid00001397";
	...
	static void registerDispenserBehaviors() {
		...
		BlockDispenser.dispenseBehaviorRegistry.putObject(Items.spawn_egg, new BehaviorDefaultDispenseItem() {
			...
			public ItemStack dispenseStack(final IBlockSource source, final ItemStack stack) {
				...
				final double var6 = source.getBlockPos().getY() + 0.2F;
				final double var8 = source.getZ() + var3.getFrontOffsetZ();
				final Entity var10 = ItemMonsterPlacer.spawnCreature(source.getWorld(), stack.getMetadata(), var4, var6,
						var8);
		...
		BlockDispenser.dispenseBehaviorRegistry.putObject(Items.fireworks, new BehaviorDefaultDispenseItem() {
			...
			public ItemStack dispenseStack(final IBlockSource source, final ItemStack stack) {
				...
				final double var6 = source.getBlockPos().getY() + 0.2F;
				final double var8 = source.getZ() + var3.getFrontOffsetZ();
				final EntityFireworkRocket var10 = new EntityFireworkRocket(source.getWorld(), var4, var6, var8, stack);
		...
		BlockDispenser.dispenseBehaviorRegistry.putObject(Items.fire_charge, new BehaviorDefaultDispenseItem() {
			...
			public ItemStack dispenseStack(final IBlockSource source, final ItemStack stack) {
				...
				final World var11 = source.getWorld();
				final Random var12 = var11.rand;
				final double var13 = var12.nextGaussian() * 0.05D + var3.getFrontOffsetX();
				final double var15 = var12.nextGaussian() * 0.05D + var3.getFrontOffsetY();
				final double var17 = var12.nextGaussian() * 0.05D + var3.getFrontOffsetZ();
		...
		BlockDispenser.dispenseBehaviorRegistry.putObject(Items.boat, new BehaviorDefaultDispenseItem() {
			...
			// private static final String __OBFID =
			// "http://https://fuckuskid00001413";
			@Override
			public ItemStack dispenseStack(final IBlockSource source, final ItemStack stack) {
				final EnumFacing var3 = BlockDispenser.getFacing(source.getBlockMetadata());
				final World var4 = source.getWorld();
				final double var5 = source.getX() + var3.getFrontOffsetX() * 1.125F;
				final double var7 = source.getY() + var3.getFrontOffsetY() * 1.125F;
				final double var9 = source.getZ() + var3.getFrontOffsetZ() * 1.125F;
				final BlockPos var11 = source.getBlockPos().offset(var3);
				final Material var12 = var4.getBlockState(var11).getBlock().getMaterial();
				double var13;
				...
				final EntityBoat var15 = new EntityBoat(var4, var5, var7 + var13, var9);
			...
			protected ItemStack dispenseStack(final IBlockSource source, final ItemStack stack) {
				...
				if (var3.isAirBlock(var4)) {
					...
					Blocks.tnt.onBlockDestroyedByPlayer(var3, var4,
							Blocks.tnt.getDefaultState().withProperty(BlockTNT.field_176246_a, true));
					var3.setBlockToAir(var4);
				} else {
		...
		BlockDispenser.dispenseBehaviorRegistry.putObject(Items.dye, new BehaviorDefaultDispenseItem() {
			...
			// private static final String __OBFID =
			// "http://https://fuckuskid00001402";
			@Override
			protected ItemStack dispenseStack(final IBlockSource source, final ItemStack stack) {
				if (EnumDyeColor.WHITE == EnumDyeColor.func_176766_a(stack.getMetadata())) {
					final World var3 = source.getWorld();
					final BlockPos var4 = source.getBlockPos()
		...
		BlockDispenser.dispenseBehaviorRegistry.putObject(Item.getItemFromBlock(Blocks.tnt),
				new BehaviorDefaultDispenseItem() {
					// private static final String __OBFID =
					// "http://https://fuckuskid00001403";
					@Override
					protected ItemStack dispenseStack(final IBlockSource source, final ItemStack stack) {
						final World var3 = source.getWorld();
						final BlockPos var4 = source.getBlockPos()
								.offset(BlockDispenser.getFacing(source.getBlockMetadata()));
						final EntityTNTPrimed var5 = new EntityTNTPrimed(var3, var4.getX() + 0.5D, var4.getY(),
								var4.getZ() + 0.5D, (EntityLivingBase) null);
		...
		BlockDispenser.dispenseBehaviorRegistry.putObject(Item.getItemFromBlock(Blocks.command_block),
				new BehaviorDefaultDispenseItem() {
					...
					protected ItemStack dispenseStack(final IBlockSource source, final ItemStack stack) {
						...
						if (var3.isAirBlock(var4)) {
							if (!var3.isRemote) {
								final IBlockState var5 = Blocks.command_block.getDefaultState()
										.withProperty(BlockCommandBlock.TRIGGERED_PROP, false);
