...
public static final int EaZy = 1573;
	...
	private final CommandBlockLogic field_145994_a = new CommandBlockLogic() {
		...
		public Vec3 getPositionVector() {
			return new Vec3(TileEntityCommandBlock.this.pos.getX() + 0.5D,
					TileEntityCommandBlock.this.pos.getY() + 0.5D, TileEntityCommandBlock.this.pos.getZ() + 0.5D);
		}
	...
	// private static final String __OBFID = "http://https://fuckuskid00000347";
