...
public static final int EaZy = 1567;
	...
	// private static final String __OBFID = "http://https://fuckuskid00000129";
	...
	private boolean isActivated() {
		final BlockPos var1 = func_177221_b();
		return getSpawnerWorld().func_175636_b(var1.getX() + 0.5D, var1.getY() + 0.5D, var1.getZ() + 0.5D,
	...
	public void updateSpawner() {
		if (isActivated()) {
			...
			if (getSpawnerWorld().isRemote) {
				final double var2 = var1.getX() + getSpawnerWorld().rand.nextFloat();
				final double var4 = var1.getY() + getSpawnerWorld().rand.nextFloat();
				var6 = var1.getZ() + getSpawnerWorld().rand.nextFloat();
				getSpawnerWorld().spawnParticle(EnumParticleTypes.SMOKE_NORMAL, var2, var4, var6, 0.0D, 0.0D, 0.0D,
						new int[0]);
				getSpawnerWorld().spawnParticle(EnumParticleTypes.FLAME, var2, var4, var6, 0.0D, 0.0D, 0.0D,
						new int[0]);
				...
				for (int var3 = 0; var3 < spawnCount; ++var3) {
					final Entity var14 = EntityList.createEntityByName(getEntityNameToSpawn(), getSpawnerWorld());

					if (var14 == null) {
						return;
					}

					final int var5 = getSpawnerWorld()
							.getEntitiesWithinAABB(var14.getClass(),
									new AxisAlignedBB(var1.getX(), var1.getY(), var1.getZ(), var1.getX() + 1,
											var1.getY() + 1, var1.getZ() + 1).expand(spawnRange, spawnRange,
													spawnRange))
							.size();
					...
					var6 = var1.getX()
							...
							+ 0.5D;
					final double var8 = var1.getY() + getSpawnerWorld().rand.nextInt(3) - 1;
					final double var10 = var1.getZ()
							+ (getSpawnerWorld().rand.nextDouble() - getSpawnerWorld().rand.nextDouble()) * spawnRange
							+ 0.5D;
					final EntityLiving var12 = var14 instanceof EntityLiving ? (EntityLiving) var14 : null;
	...
	private Entity func_180613_a(final Entity p_180613_1_, final boolean p_180613_2_) {
		if (getRandomEntity() != null) {
			...
			final Iterator var4 = getRandomEntity().field_98222_b.getKeySet().iterator();

			while (var4.hasNext()) {
				final String var5 = (String) var4.next();
				final NBTBase var6 = getRandomEntity().field_98222_b.getTag(var5);
			...
			for (Entity var11 = p_180613_1_; var3.hasKey("Riding", 10); var3 = var12) {
				...
				final Entity var13 = EntityList.createEntityByName(var12.getString("id"), p_180613_1_.worldObj);

				if (var13 != null) {
					final NBTTagCompound var7 = new NBTTagCompound();
					var13.writeToNBTOptional(var7);
					final Iterator var8 = var12.getKeySet().iterator();

					while (var8.hasNext()) {
						final String var9 = (String) var8.next();
						final NBTBase var10 = var12.getTag(var9);
	...
	public void readFromNBT(final NBTTagCompound p_98270_1_) {
		...
		if (p_98270_1_.hasKey("SpawnData", 10)) {
			setRandomEntity(
					new MobSpawnerBaseLogic.WeightedRandomMinecart(p_98270_1_.getCompoundTag("SpawnData"), mobID));
		} else {
	...
	public class WeightedRandomMinecart extends WeightedRandom.Item {
		...
		public WeightedRandomMinecart(final NBTTagCompound p_i1946_2_, final String p_i1946_3_) {
