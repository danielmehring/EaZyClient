...
public static final int EaZy = 1569;
	...
	// private static final String __OBFID = "http://https://fuckuskid00002044";
			...
			if (!field_175119_g) {
				...
				if (field_175118_f != null) {
					for (int var1 = 0; var1 < field_175118_f.tagCount(); ++var1) {
						final NBTTagCompound var2 = field_175118_f.getCompoundTagAt(var1);
						final TileEntityBanner.EnumBannerPattern var3 = TileEntityBanner.EnumBannerPattern
	...
	public static enum EnumBannerPattern {
		...
		private EnumBannerPattern(final String p_i45670_1_, final int p_i45670_2_, final String p_i45670_3_,
				final String p_i45670_4_) {
			field_177291_P = new String[3];
			field_177284_N = p_i45670_3_;
			field_177285_O = p_i45670_4_;
		}

		private EnumBannerPattern(final String p_i45671_1_, final int p_i45671_2_, final String p_i45671_3_,
				final String p_i45671_4_, final ItemStack p_i45671_5_) {
			this(p_i45671_1_, p_i45671_2_, p_i45671_3_, p_i45671_4_);
			field_177290_Q = p_i45671_5_;
		}

		private EnumBannerPattern(final String p_i45672_1_, final int p_i45672_2_, final String p_i45672_3_,
				final String p_i45672_4_, final String p_i45672_5_, final String p_i45672_6_,
				final String p_i45672_7_) {
		...
		public static TileEntityBanner.EnumBannerPattern func_177268_a(final String p_177268_0_) {
			final TileEntityBanner.EnumBannerPattern[] var1 = values();
			final int var2 = var1.length;

			for (int var3 = 0; var3 < var2; ++var3) {
				final TileEntityBanner.EnumBannerPattern var4 = var1[var3];
