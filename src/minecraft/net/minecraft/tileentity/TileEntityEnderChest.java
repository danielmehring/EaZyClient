...
public static final int EaZy = 1579;
	...
	// private static final String __OBFID = "http://https://fuckuskid00000355";
	...
	public void update() {
		...
		if (field_145973_j > 0 && field_145972_a == 0.0F) {
			final double var5 = var1 + 0.5D;
			var7 = var3 + 0.5D;
			worldObj.playSoundEffect(var5, var2 + 0.5D, var7, "random.chestopen", 0.5F,
					worldObj.rand.nextFloat() * 0.1F + 0.9F);
		}

		if (field_145973_j == 0 && field_145972_a > 0.0F || field_145973_j > 0 && field_145972_a < 1.0F) {
			final float var11 = field_145972_a;
			...
			if (field_145972_a < var6 && var11 >= var6) {
				var7 = var1 + 0.5D;
				final double var9 = var3 + 0.5D;
				worldObj.playSoundEffect(var7, var2 + 0.5D, var9, "random.chestclosed", 0.5F,
						worldObj.rand.nextFloat() * 0.1F + 0.9F);
			}
	...
	public boolean func_145971_a(final EntityPlayer p_145971_1_) {
		return worldObj.getTileEntity(pos) != this ? false
				: p_145971_1_.getDistanceSq(pos.getX() + 0.5D, pos.getY() + 0.5D, pos.getZ() + 0.5D) <= 64.0D;
	}
}
