...
public static final int EaZy = 1582;
	...
	// private static final String __OBFID = "http://https://fuckuskid00000357";
	...
	public ItemStack getStackInSlotOnClosing(final int index) {
		if (furnaceItemStacks[index] != null) {
			final ItemStack var2 = furnaceItemStacks[index];
			furnaceItemStacks[index] = null;
			return var2;
		} else {
			return null;
	...
	public void setInventorySlotContents(final int index, final ItemStack stack) {
		final boolean var3 = stack != null && stack.isItemEqual(furnaceItemStacks[index])
					...
					if (isBurning()) {
						...
						if (furnaceItemStacks[1] != null) {
							...
							if (furnaceItemStacks[1].stackSize == 0) {
								final Item var3 = furnaceItemStacks[1].getItem().getContainerItem();
	...
	private boolean canSmelt() {
		if (furnaceItemStacks[0] == null) {
			...
			final ItemStack var1 = FurnaceRecipes.instance().getSmeltingResult(furnaceItemStacks[0]);
							...
							: !furnaceItemStacks[2].isItemEqual(var1) ? false
									: furnaceItemStacks[2].stackSize < getInventoryStackLimit()
											&& furnaceItemStacks[2].stackSize < furnaceItemStacks[2].getMaxStackSize()
													? true : furnaceItemStacks[2].stackSize < var1.getMaxStackSize();
		}
	}
