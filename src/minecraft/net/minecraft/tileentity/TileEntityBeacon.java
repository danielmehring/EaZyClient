...
public static final int EaZy = 1570;
	...
	// private static final String __OBFID = "http://https://fuckuskid00000339";
	...
	private void func_146000_x() {
		if (isComplete && levels > 0 && !worldObj.isRemote && primaryEffect > 0) {
			...
			final AxisAlignedBB var7 = new AxisAlignedBB(var4, var5, var6, var4 + 1, var5 + 1, var6 + 1)
					.expand(var1, var1, var1).addCoord(0.0D, worldObj.getHeight(), 0.0D);
			final List var8 = worldObj.getEntitiesWithinAABB(EntityPlayer.class, var7);
	...
	private void func_146003_y() {
		...
		for (var7 = var3 + 1; var7 < worldObj.getActualHeight(); ++var7) {
			...
			final IBlockState var9 = worldObj.getBlockState(var8);
			float[] var10;
			...
			for (var7 = 1; var7 <= 4; levels = var7++) {
				...
				for (int var17 = var2 - var7; var17 <= var2 + var7 && var16; ++var17) {
					for (int var11 = var4 - var7; var11 <= var4 + var7; ++var11) {
						final Block var12 = worldObj.getBlockState(new BlockPos(var17, var14, var11)).getBlock();
		...
		if (!worldObj.isRemote && levels == 4 && var1 < levels) {
			final Iterator var13 = worldObj
					.getEntitiesWithinAABB(EntityPlayer.class,
							new AxisAlignedBB(var2, var3, var4, var2, var3 - 4, var4).expand(10.0D, 5.0D, 10.0D))
					.iterator();

			while (var13.hasNext()) {
				final EntityPlayer var15 = (EntityPlayer) var13.next();
