...
public static final int EaZy = 1555;
	...
	// private static final String __OBFID = "http://https://fuckuskid00001466";

	public Achievement(final String p_i46327_1_, final String p_i46327_2_, final int p_i46327_3_, final int p_i46327_4_,
			final Item p_i46327_5_, final Achievement p_i46327_6_) {
		this(p_i46327_1_, p_i46327_2_, p_i46327_3_, p_i46327_4_, new ItemStack(p_i46327_5_), p_i46327_6_);
	}

	public Achievement(final String p_i45301_1_, final String p_i45301_2_, final int p_i45301_3_, final int p_i45301_4_,
			final Block p_i45301_5_, final Achievement p_i45301_6_) {
		this(p_i45301_1_, p_i45301_2_, p_i45301_3_, p_i45301_4_, new ItemStack(p_i45301_5_), p_i45301_6_);
	}

	public Achievement(final String p_i45302_1_, final String p_i45302_2_, final int p_i45302_3_, final int p_i45302_4_,
			final ItemStack p_i45302_5_, final Achievement p_i45302_6_) {
