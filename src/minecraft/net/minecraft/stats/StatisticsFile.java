...
public static final int EaZy = 1564;
	...
	// private static final String __OBFID = "http://https://fuckuskid00001471";
	...
	public void func_150873_a(final EntityPlayer p_150873_1_, final StatBase p_150873_2_, final int p_150873_3_) {
		final int var4 = p_150873_2_.isAchievement() ? writeStat(p_150873_2_) : 0;
	...
	public Map func_150881_a(final String p_150881_1_) {
		...
		if (!var2.isJsonObject()) {
			...
			while (var5.hasNext()) {
				...
				final StatBase var7 = StatList.getOneShotStat((String) var6.getKey());
				...
				if (var7 != null) {
					...
					if (((JsonElement) var6.getValue()).isJsonPrimitive()
						...
						final JsonObject var9 = ((JsonElement) var6.getValue()).getAsJsonObject();
						...
						if (var9.has("progress") && var7.func_150954_l() != null) {
							try {
								final Constructor var10 = var7.func_150954_l().getConstructor(new Class[0]);
								final IJsonSerializable var11 = (IJsonSerializable) var10.newInstance(new Object[0]);
