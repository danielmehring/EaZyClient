...
public static final int EaZy = 293;
	...
	// private static final String __OBFID = "http://https://fuckuskid00000233";
	...
	protected void func_176439_d(final World worldIn, final BlockPos p_176439_2_) {
		...
		if (var4 != null) {
			...
			if (var5 < 0) {
				...
				if (var6 != null) {
					final EnumFacing var7 = (EnumFacing) worldIn.getBlockState(p_176439_2_).getValue(FACING);
					final BlockPos var8 = p_176439_2_.offset(var7);
					final IInventory var9 = TileEntityHopper.func_145893_b(worldIn, var8.getX(), var8.getY(),
							var8.getZ());
					ItemStack var10;
