...
public static final int EaZy = 353;
	...
	// private static final String __OBFID = "http://https://fuckuskid00000291";
	...
	public boolean func_176390_d(final World worldIn, final BlockPos p_176390_2_) {
		return func_176392_j().func_177681_a(worldIn, p_176390_2_) != null
				|| func_176389_S().func_177681_a(worldIn, p_176390_2_) != null;
	}
	...
	private void createGolem(final World worldIn, final BlockPos p_180673_2_) {
		...
		if ((var3 = func_176391_l().func_177681_a(worldIn, p_180673_2_)) != null) {
			...
			final EntitySnowman var9 = new EntitySnowman(worldIn);
			final BlockPos var11 = var3.func_177670_a(0, 2, 0).getPos();
			...
			for (var6 = 0; var6 < 120; ++var6) {
				worldIn.spawnParticle(EnumParticleTypes.SNOW_SHOVEL, var11.getX() + worldIn.rand.nextDouble(),
						var11.getY() + worldIn.rand.nextDouble() * 2.5D, var11.getZ() + worldIn.rand.nextDouble(), 0.0D,
						0.0D, 0.0D, new int[0]);
			}

			for (var6 = 0; var6 < func_176391_l().func_177685_b(); ++var6) {
				final BlockWorldState var7 = var3.func_177670_a(0, var6, 0);
			...
			final BlockPos var10 = var3.func_177670_a(1, 2, 0).getPos();
			final EntityIronGolem var13 = new EntityIronGolem(worldIn);
			...
			for (var6 = 0; var6 < 120; ++var6) {
				worldIn.spawnParticle(EnumParticleTypes.SNOWBALL, var10.getX() + worldIn.rand.nextDouble(),
						var10.getY() + worldIn.rand.nextDouble() * 3.9D, var10.getZ() + worldIn.rand.nextDouble(), 0.0D,
						0.0D, 0.0D, new int[0]);
			}

			for (var6 = 0; var6 < func_176388_T().func_177684_c(); ++var6) {
				for (int var14 = 0; var14 < func_176388_T().func_177685_b(); ++var14) {
					final BlockWorldState var8 = var3.func_177670_a(var6, var14, 0);
	...
	protected BlockPattern func_176392_j() {
		if (field_176394_a == null) {
			field_176394_a = FactoryBlockPattern.start().aisle(new String[] { " ", "#", "#" })
	...
	protected BlockPattern func_176391_l() {
		if (field_176393_b == null) {
			field_176393_b = FactoryBlockPattern.start().aisle(new String[] { "^", "#", "#" })
	...
	protected BlockPattern func_176389_S() {
		if (field_176395_M == null) {
			field_176395_M = FactoryBlockPattern.start().aisle(new String[] { "~ ~", "###", "~#~" })
	...
	protected BlockPattern func_176388_T() {
		if (field_176396_O == null) {
			field_176396_O = FactoryBlockPattern.start().aisle(new String[] { "~^~", "###", "~#~" })
					.where('^', BlockWorldState.hasState(BlockStateHelper.forBlock(Blocks.pumpkin)))
					.where('#', BlockWorldState.hasState(BlockStateHelper.forBlock(Blocks.iron_block)))
					.where('~', BlockWorldState.hasState(BlockStateHelper.forBlock(Blocks.air))).build();
		}
