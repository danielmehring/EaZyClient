...
public static final int EaZy = 1955;
	...
	public static boolean callBoolean(final ReflectorMethod refMethod, final Object... params) {
		try {
			...
			if (e == null) {
				...
				final Boolean retVal = (Boolean) e.invoke((Object) null, params);
				return retVal;
			}
	...
	public static int callInt(final ReflectorMethod refMethod, final Object... params) {
		try {
			...
			if (e == null) {
				...
				final Integer retVal = (Integer) e.invoke((Object) null, params);
				return retVal;
			}
		} catch (final Throwable var4) {
			handleException(var4, (Object) null, refMethod, params);
	...
	public static double callDouble(final ReflectorMethod refMethod, final Object... params) {
		try {
			...
			if (e == null) {
				...
				final Double retVal = (Double) e.invoke((Object) null, params);
				return retVal;
			}
		} catch (final Throwable var4) {
			handleException(var4, (Object) null, refMethod, params);
	...
	public static boolean postForgeBusEvent(final Object event) {
		if (event == null) {
			...
			if (eventBus == null) {
				...
				final Object ret = call(eventBus, EventBus_post, new Object[] { event });
	...
	public static Method[] getMethods(final Class cls, final String methodName) {
		...
		final Method[] var6 = (Method[]) listMethods.toArray(new Method[listMethods.size()]);
		return var6;
	}
	...
	private static void handleException(final Throwable e, final Object obj, final ReflectorMethod refMethod,
			final Object[] params) {
	...
	private static void handleException(final Throwable e, final ReflectorConstructor refConstr,
			final Object[] params) {
		if (e instanceof InvocationTargetException) {
			e.printStackTrace();
		} else {
	...
	public static Field[] getFields(final Class cls, final Class fieldType) {
		...
		try {
			...
			final Field[] var7 = (Field[]) list.toArray(new Field[list.size()]);
			return var7;
