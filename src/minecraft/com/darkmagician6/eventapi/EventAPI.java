/**
 * This is an API used for handling events across your java based projects. It's
 * meant to be simple to use without sacrificing performance and extensibility.
 *
 * Currently the API is in beta phase but it's stable and ready to be used.
 *
 * If you have any suggestion for improvements/fixes for shit, feel free to make
 * a pull request on the bitbucket:
 * https://bitbucket.org/DarkMagician6/eventapi/overview.
 *
